...
@protected RustStreamSink<RsProcessStreamData> dco_decode_StreamSink_rs_process_stream_data_Dco(dynamic raw);

@protected String dco_decode_String(dynamic raw);

@protected ApplinksRegistrationResult dco_decode_applinks_registration_result(dynamic raw);

@protected AssemblyGraphStats dco_decode_assembly_graph_stats(dynamic raw);

@protected AudioPlaybackState dco_decode_audio_playback_state(dynamic raw);

@protected bool dco_decode_bool(dynamic raw);

@protected bool dco_decode_box_autoadd_bool(dynamic raw);

@protected ModelConvertOptions dco_decode_box_autoadd_model_convert_options(dynamic raw);

@protected RsiLauncherAsarData dco_decode_box_autoadd_rsi_launcher_asar_data(dynamic raw);

@protected int dco_decode_box_autoadd_u_32(dynamic raw);

@protected BigInt dco_decode_box_autoadd_u_64(dynamic raw);

@protected WebViewConfiguration dco_decode_box_autoadd_web_view_configuration(dynamic raw);

@protected DcbRecordItem dco_decode_dcb_record_item(dynamic raw);

@protected DcbSearchMatch dco_decode_dcb_search_match(dynamic raw);

@protected DcbSearchResult dco_decode_dcb_search_result(dynamic raw);

@protected DownloadGlobalStat dco_decode_download_global_stat(dynamic raw);

@protected DownloadTaskInfo dco_decode_download_task_info(dynamic raw);

@protected DownloadTaskStatus dco_decode_download_task_status(dynamic raw);
...
@protected List<DcbRecordItem> dco_decode_list_dcb_record_item(dynamic raw);

@protected List<DcbSearchMatch> dco_decode_list_dcb_search_match(dynamic raw);

@protected List<DcbSearchResult> dco_decode_list_dcb_search_result(dynamic raw);

@protected List<DownloadTaskInfo> dco_decode_list_download_task_info(dynamic raw);

@protected List<LocalBatchFileResult> dco_decode_list_local_batch_file_result(dynamic raw);

@protected List<P4kFileItem> dco_decode_list_p_4_k_file_item(dynamic raw);

@protected List<int> dco_decode_list_prim_u_8_loose(dynamic raw);

@protected Uint8List dco_decode_list_prim_u_8_strict(dynamic raw);

@protected List<ProcessInfo> dco_decode_list_process_info(dynamic raw);

@protected List<(String,String)> dco_decode_list_record_string_string(dynamic raw);

@protected List<WebViewEvent> dco_decode_list_web_view_event(dynamic raw);

@protected LocalBatchConvertResult dco_decode_local_batch_convert_result(dynamic raw);

@protected LocalBatchFileResult dco_decode_local_batch_file_result(dynamic raw);

@protected ModelConvertOptions dco_decode_model_convert_options(dynamic raw);

@protected ModelConvertResult dco_decode_model_convert_result(dynamic raw);

@protected MyHttpVersion dco_decode_my_http_version(dynamic raw);

@protected MyMethod dco_decode_my_method(dynamic raw);
...
@protected ModelConvertOptions? dco_decode_opt_box_autoadd_model_convert_options(dynamic raw);
...
@protected P4kFileItem dco_decode_p_4_k_file_item(dynamic raw);

@protected ProcessInfo dco_decode_process_info(dynamic raw);

@protected (String,String) dco_decode_record_string_string(dynamic raw);

@protected RsProcessStreamData dco_decode_rs_process_stream_data(dynamic raw);

@protected RsProcessStreamDataType dco_decode_rs_process_stream_data_type(dynamic raw);

@protected RsiLauncherAsarData dco_decode_rsi_launcher_asar_data(dynamic raw);

@protected RustHttpResponse dco_decode_rust_http_response(dynamic raw);
...
@protected WebViewConfiguration dco_decode_web_view_configuration(dynamic raw);

@protected WebViewEvent dco_decode_web_view_event(dynamic raw);

@protected WebViewNavigationState dco_decode_web_view_navigation_state(dynamic raw);

@protected AnyhowException sse_decode_AnyhowException(SseDeserializer deserializer);

@protected Map<String, String> sse_decode_Map_String_String_None(SseDeserializer deserializer);

@protected RustStreamSink<RsProcessStreamData> sse_decode_StreamSink_rs_process_stream_data_Dco(SseDeserializer deserializer);

@protected String sse_decode_String(SseDeserializer deserializer);

@protected ApplinksRegistrationResult sse_decode_applinks_registration_result(SseDeserializer deserializer);

@protected AssemblyGraphStats sse_decode_assembly_graph_stats(SseDeserializer deserializer);

@protected AudioPlaybackState sse_decode_audio_playback_state(SseDeserializer deserializer);

@protected bool sse_decode_bool(SseDeserializer deserializer);

@protected bool sse_decode_box_autoadd_bool(SseDeserializer deserializer);

@protected ModelConvertOptions sse_decode_box_autoadd_model_convert_options(SseDeserializer deserializer);

@protected RsiLauncherAsarData sse_decode_box_autoadd_rsi_launcher_asar_data(SseDeserializer deserializer);
...
@protected WebViewConfiguration sse_decode_box_autoadd_web_view_configuration(SseDeserializer deserializer);

@protected DcbRecordItem sse_decode_dcb_record_item(SseDeserializer deserializer);

@protected DcbSearchMatch sse_decode_dcb_search_match(SseDeserializer deserializer);

@protected DcbSearchResult sse_decode_dcb_search_result(SseDeserializer deserializer);

@protected DownloadGlobalStat sse_decode_download_global_stat(SseDeserializer deserializer);

@protected DownloadTaskInfo sse_decode_download_task_info(SseDeserializer deserializer);

@protected DownloadTaskStatus sse_decode_download_task_status(SseDeserializer deserializer);
...
@protected List<DcbRecordItem> sse_decode_list_dcb_record_item(SseDeserializer deserializer);

@protected List<DcbSearchMatch> sse_decode_list_dcb_search_match(SseDeserializer deserializer);

@protected List<DcbSearchResult> sse_decode_list_dcb_search_result(SseDeserializer deserializer);

@protected List<DownloadTaskInfo> sse_decode_list_download_task_info(SseDeserializer deserializer);

@protected List<LocalBatchFileResult> sse_decode_list_local_batch_file_result(SseDeserializer deserializer);

@protected List<P4kFileItem> sse_decode_list_p_4_k_file_item(SseDeserializer deserializer);

@protected List<int> sse_decode_list_prim_u_8_loose(SseDeserializer deserializer);

@protected Uint8List sse_decode_list_prim_u_8_strict(SseDeserializer deserializer);

@protected List<ProcessInfo> sse_decode_list_process_info(SseDeserializer deserializer);

@protected List<(String,String)> sse_decode_list_record_string_string(SseDeserializer deserializer);

@protected List<WebViewEvent> sse_decode_list_web_view_event(SseDeserializer deserializer);

@protected LocalBatchConvertResult sse_decode_local_batch_convert_result(SseDeserializer deserializer);

@protected LocalBatchFileResult sse_decode_local_batch_file_result(SseDeserializer deserializer);

@protected ModelConvertOptions sse_decode_model_convert_options(SseDeserializer deserializer);

@protected ModelConvertResult sse_decode_model_convert_result(SseDeserializer deserializer);

@protected MyHttpVersion sse_decode_my_http_version(SseDeserializer deserializer);

@protected MyMethod sse_decode_my_method(SseDeserializer deserializer);
...
@protected ModelConvertOptions? sse_decode_opt_box_autoadd_model_convert_options(SseDeserializer deserializer);
...
@protected P4kFileItem sse_decode_p_4_k_file_item(SseDeserializer deserializer);

@protected ProcessInfo sse_decode_process_info(SseDeserializer deserializer);

@protected (String,String) sse_decode_record_string_string(SseDeserializer deserializer);

@protected RsProcessStreamData sse_decode_rs_process_stream_data(SseDeserializer deserializer);

@protected RsProcessStreamDataType sse_decode_rs_process_stream_data_type(SseDeserializer deserializer);

@protected RsiLauncherAsarData sse_decode_rsi_launcher_asar_data(SseDeserializer deserializer);

@protected RustHttpResponse sse_decode_rust_http_response(SseDeserializer deserializer);
...
@protected WebViewConfiguration sse_decode_web_view_configuration(SseDeserializer deserializer);

@protected WebViewEvent sse_decode_web_view_event(SseDeserializer deserializer);

@protected WebViewNavigationState sse_decode_web_view_navigation_state(SseDeserializer deserializer);
...
@protected ffi.Pointer<wire_cst_list_record_string_string> cst_encode_Map_String_String_None(Map<String, String> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return cst_encode_list_record_string_string(raw.entries.map((e) => (e.key, e.value)).toList()); }

@protected ffi.Pointer<wire_cst_list_prim_u_8_strict> cst_encode_StreamSink_rs_process_stream_data_Dco(RustStreamSink<RsProcessStreamData> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_model_convert_options> cst_encode_box_autoadd_model_convert_options(ModelConvertOptions raw){ // Codec=Cst (C-struct based), see doc to use other codecs
final ptr = wire.cst_new_box_autoadd_model_convert_options();
                    cst_api_fill_to_wire_model_convert_options(raw, ptr.ref);
                    return ptr; }

@protected ffi.Pointer<wire_cst_rsi_launcher_asar_data> cst_encode_box_autoadd_rsi_launcher_asar_data(RsiLauncherAsarData raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_web_view_configuration> cst_encode_box_autoadd_web_view_configuration(WebViewConfiguration raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_dcb_record_item> cst_encode_list_dcb_record_item(List<DcbRecordItem> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_dcb_search_match> cst_encode_list_dcb_search_match(List<DcbSearchMatch> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_dcb_search_result> cst_encode_list_dcb_search_result(List<DcbSearchResult> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_download_task_info> cst_encode_list_download_task_info(List<DownloadTaskInfo> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_local_batch_file_result> cst_encode_list_local_batch_file_result(List<LocalBatchFileResult> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_p_4_k_file_item> cst_encode_list_p_4_k_file_item(List<P4kFileItem> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_process_info> cst_encode_list_process_info(List<ProcessInfo> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_web_view_event> cst_encode_list_web_view_event(List<WebViewEvent> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_list_record_string_string> cst_encode_opt_Map_String_String_None(Map<String, String>? raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<wire_cst_model_convert_options> cst_encode_opt_box_autoadd_model_convert_options(ModelConvertOptions? raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return raw == null ? ffi.nullptr : cst_encode_box_autoadd_model_convert_options(raw); }
...
@protected ffi.Pointer<wire_cst_list_prim_u_8_strict> cst_encode_opt_list_prim_u_8_strict(Uint8List? raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected void cst_api_fill_to_wire_applinks_registration_result(ApplinksRegistrationResult apiObj, wire_cst_applinks_registration_result wireObj){ wireObj.success = cst_encode_bool(apiObj.success);
wireObj.message = cst_encode_String(apiObj.message);
wireObj.was_modified = cst_encode_bool(apiObj.wasModified); }

@protected void cst_api_fill_to_wire_assembly_graph_stats(AssemblyGraphStats apiObj, wire_cst_assembly_graph_stats wireObj){ wireObj.nodes = cst_encode_i_32(apiObj.nodes);
...
@protected void cst_api_fill_to_wire_audio_playback_state(AudioPlaybackState apiObj, wire_cst_audio_playback_state wireObj){ wireObj.current_source_path = cst_encode_opt_String(apiObj.currentSourcePath);
...
@protected void cst_api_fill_to_wire_box_autoadd_model_convert_options(ModelConvertOptions apiObj, ffi.Pointer<wire_cst_model_convert_options> wireObj){ cst_api_fill_to_wire_model_convert_options(apiObj, wireObj.ref); }

@protected void cst_api_fill_to_wire_box_autoadd_rsi_launcher_asar_data(RsiLauncherAsarData apiObj, ffi.Pointer<wire_cst_rsi_launcher_asar_data> wireObj){ cst_api_fill_to_wire_rsi_launcher_asar_data(apiObj, wireObj.ref); }

@protected void cst_api_fill_to_wire_box_autoadd_web_view_configuration(WebViewConfiguration apiObj, ffi.Pointer<wire_cst_web_view_configuration> wireObj){ cst_api_fill_to_wire_web_view_configuration(apiObj, wireObj.ref); }

@protected void cst_api_fill_to_wire_dcb_record_item(DcbRecordItem apiObj, wire_cst_dcb_record_item wireObj){ wireObj.path = cst_encode_String(apiObj.path);
wireObj.index = cst_encode_usize(apiObj.index); }

@protected void cst_api_fill_to_wire_dcb_search_match(DcbSearchMatch apiObj, wire_cst_dcb_search_match wireObj){ wireObj.line_number = cst_encode_usize(apiObj.lineNumber);
wireObj.line_content = cst_encode_String(apiObj.lineContent); }

@protected void cst_api_fill_to_wire_dcb_search_result(DcbSearchResult apiObj, wire_cst_dcb_search_result wireObj){ wireObj.path = cst_encode_String(apiObj.path);
wireObj.index = cst_encode_usize(apiObj.index);
wireObj.matches = cst_encode_list_dcb_search_match(apiObj.matches); }

@protected void cst_api_fill_to_wire_download_global_stat(DownloadGlobalStat apiObj, wire_cst_download_global_stat wireObj){ wireObj.download_speed = cst_encode_u_64(apiObj.downloadSpeed);
...
@protected void cst_api_fill_to_wire_download_task_info(DownloadTaskInfo apiObj, wire_cst_download_task_info wireObj){ wireObj.id = cst_encode_usize(apiObj.id);
...
@protected void cst_api_fill_to_wire_local_batch_convert_result(LocalBatchConvertResult apiObj, wire_cst_local_batch_convert_result wireObj){ wireObj.success = cst_encode_bool(apiObj.success);
wireObj.merged_output_path = cst_encode_opt_String(apiObj.mergedOutputPath);
wireObj.assembly_manifest_path = cst_encode_opt_String(apiObj.assemblyManifestPath);
wireObj.assembly_report_path = cst_encode_opt_String(apiObj.assemblyReportPath);
...
cst_api_fill_to_wire_assembly_graph_stats(apiObj.assemblyGraphStats, wireObj.assembly_graph_stats);
wireObj.fallback_reason_by_file = cst_encode_list_String(apiObj.fallbackReasonByFile);
wireObj.error_code = cst_encode_opt_String(apiObj.errorCode);
wireObj.error_message = cst_encode_opt_String(apiObj.errorMessage); }

@protected void cst_api_fill_to_wire_local_batch_file_result(LocalBatchFileResult apiObj, wire_cst_local_batch_file_result wireObj){ wireObj.model_path = cst_encode_String(apiObj.modelPath);
...
@protected void cst_api_fill_to_wire_model_convert_options(ModelConvertOptions apiObj, wire_cst_model_convert_options wireObj){ wireObj.embed_textures = cst_encode_bool(apiObj.embedTextures);
wireObj.overwrite = cst_encode_bool(apiObj.overwrite);
wireObj.max_texture_size = cst_encode_opt_box_autoadd_u_32(apiObj.maxTextureSize); }

@protected void cst_api_fill_to_wire_model_convert_result(ModelConvertResult apiObj, wire_cst_model_convert_result wireObj){ wireObj.success = cst_encode_bool(apiObj.success);
wireObj.output_path = cst_encode_opt_String(apiObj.outputPath);
wireObj.error_code = cst_encode_opt_String(apiObj.errorCode);
wireObj.error_message = cst_encode_opt_String(apiObj.errorMessage);
wireObj.warnings = cst_encode_list_String(apiObj.warnings); }

@protected void cst_api_fill_to_wire_p_4_k_file_item(P4kFileItem apiObj, wire_cst_p_4_k_file_item wireObj){ wireObj.name = cst_encode_String(apiObj.name);
...
@protected void cst_api_fill_to_wire_process_info(ProcessInfo apiObj, wire_cst_process_info wireObj){ wireObj.pid = cst_encode_u_32(apiObj.pid);
wireObj.name = cst_encode_String(apiObj.name);
...
@protected void cst_api_fill_to_wire_rs_process_stream_data(RsProcessStreamData apiObj, wire_cst_rs_process_stream_data wireObj){ wireObj.data_type = cst_encode_rs_process_stream_data_type(apiObj.dataType);
wireObj.data = cst_encode_String(apiObj.data);
wireObj.rs_pid = cst_encode_u_32(apiObj.rsPid); }

@protected void cst_api_fill_to_wire_rsi_launcher_asar_data(RsiLauncherAsarData apiObj, wire_cst_rsi_launcher_asar_data wireObj){ wireObj.asar_path = cst_encode_String(apiObj.asarPath);
wireObj.main_js_path = cst_encode_String(apiObj.mainJsPath);
wireObj.main_js_content = cst_encode_list_prim_u_8_strict(apiObj.mainJsContent); }

@protected void cst_api_fill_to_wire_rust_http_response(RustHttpResponse apiObj, wire_cst_rust_http_response wireObj){ wireObj.status_code = cst_encode_u_16(apiObj.statusCode);
wireObj.headers = cst_encode_Map_String_String_None(apiObj.headers);
wireObj.url = cst_encode_String(apiObj.url);
wireObj.content_length = cst_encode_opt_box_autoadd_u_64(apiObj.contentLength);
...
@protected void cst_api_fill_to_wire_system_info(SystemInfo apiObj, wire_cst_system_info wireObj){ wireObj.os_name = cst_encode_String(apiObj.osName);
...
@protected void cst_api_fill_to_wire_web_view_configuration(WebViewConfiguration apiObj, wire_cst_web_view_configuration wireObj){ wireObj.title = cst_encode_String(apiObj.title);
...
@protected void cst_api_fill_to_wire_web_view_event(WebViewEvent apiObj, wire_cst_web_view_event wireObj){ if (apiObj is WebViewEvent_NavigationStarted) {
                var pre_url = cst_encode_String(apiObj.url);wireObj.tag = 0;wireObj.kind.NavigationStarted.url = pre_url;
                return;
            }
if (apiObj is WebViewEvent_NavigationCompleted) {
                var pre_url = cst_encode_String(apiObj.url);wireObj.tag = 1;wireObj.kind.NavigationCompleted.url = pre_url;
                return;
            }
if (apiObj is WebViewEvent_TitleChanged) {
                var pre_title = cst_encode_String(apiObj.title);wireObj.tag = 2;wireObj.kind.TitleChanged.title = pre_title;
                return;
            }
if (apiObj is WebViewEvent_WebMessage) {
                var pre_message = cst_encode_String(apiObj.message);wireObj.tag = 3;wireObj.kind.WebMessage.message = pre_message;
                return;
            }
...
if (apiObj is WebViewEvent_Error) {
                var pre_message = cst_encode_String(apiObj.message);wireObj.tag = 5;wireObj.kind.Error.message = pre_message;
                return;
            } }

@protected void cst_api_fill_to_wire_web_view_navigation_state(WebViewNavigationState apiObj, wire_cst_web_view_navigation_state wireObj){ wireObj.url = cst_encode_String(apiObj.url);
...
@protected int cst_encode_download_task_status(DownloadTaskStatus raw);

@protected double cst_encode_f_64(double raw);

@protected int cst_encode_i_32(int raw);

@protected int cst_encode_my_http_version(MyHttpVersion raw);

@protected int cst_encode_my_method(MyMethod raw);

@protected int cst_encode_rs_process_stream_data_type(RsProcessStreamDataType raw);
...
@protected void sse_encode_StreamSink_rs_process_stream_data_Dco(RustStreamSink<RsProcessStreamData> self, SseSerializer serializer);

@protected void sse_encode_String(String self, SseSerializer serializer);

@protected void sse_encode_applinks_registration_result(ApplinksRegistrationResult self, SseSerializer serializer);

@protected void sse_encode_assembly_graph_stats(AssemblyGraphStats self, SseSerializer serializer);

@protected void sse_encode_audio_playback_state(AudioPlaybackState self, SseSerializer serializer);

@protected void sse_encode_bool(bool self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_bool(bool self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_model_convert_options(ModelConvertOptions self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_rsi_launcher_asar_data(RsiLauncherAsarData self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_u_32(int self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_u_64(BigInt self, SseSerializer serializer);

@protected void sse_encode_box_autoadd_web_view_configuration(WebViewConfiguration self, SseSerializer serializer);

@protected void sse_encode_dcb_record_item(DcbRecordItem self, SseSerializer serializer);

@protected void sse_encode_dcb_search_match(DcbSearchMatch self, SseSerializer serializer);
...
@protected void sse_encode_list_dcb_record_item(List<DcbRecordItem> self, SseSerializer serializer);

@protected void sse_encode_list_dcb_search_match(List<DcbSearchMatch> self, SseSerializer serializer);

@protected void sse_encode_list_dcb_search_result(List<DcbSearchResult> self, SseSerializer serializer);

@protected void sse_encode_list_download_task_info(List<DownloadTaskInfo> self, SseSerializer serializer);

@protected void sse_encode_list_local_batch_file_result(List<LocalBatchFileResult> self, SseSerializer serializer);

@protected void sse_encode_list_p_4_k_file_item(List<P4kFileItem> self, SseSerializer serializer);

@protected void sse_encode_list_prim_u_8_loose(List<int> self, SseSerializer serializer);

@protected void sse_encode_list_prim_u_8_strict(Uint8List self, SseSerializer serializer);

@protected void sse_encode_list_process_info(List<ProcessInfo> self, SseSerializer serializer);

@protected void sse_encode_list_record_string_string(List<(String,String)> self, SseSerializer serializer);

@protected void sse_encode_list_web_view_event(List<WebViewEvent> self, SseSerializer serializer);

@protected void sse_encode_local_batch_convert_result(LocalBatchConvertResult self, SseSerializer serializer);

@protected void sse_encode_local_batch_file_result(LocalBatchFileResult self, SseSerializer serializer);

@protected void sse_encode_model_convert_options(ModelConvertOptions self, SseSerializer serializer);

@protected void sse_encode_model_convert_result(ModelConvertResult self, SseSerializer serializer);

@protected void sse_encode_my_http_version(MyHttpVersion self, SseSerializer serializer);

@protected void sse_encode_my_method(MyMethod self, SseSerializer serializer);
...
@protected void sse_encode_opt_box_autoadd_model_convert_options(ModelConvertOptions? self, SseSerializer serializer);
...
@protected void sse_encode_process_info(ProcessInfo self, SseSerializer serializer);

@protected void sse_encode_record_string_string((String,String) self, SseSerializer serializer);

@protected void sse_encode_rs_process_stream_data(RsProcessStreamData self, SseSerializer serializer);

@protected void sse_encode_rs_process_stream_data_type(RsProcessStreamDataType self, SseSerializer serializer);
