...
mixin _$Unp4kcState {
 ...
 DateTime? get dateFilterRangeEnd;/// 后缀筛选（多选）
 Set<String> get suffixFilter; Unp4kViewMode get viewMode; Unp4kModelCategory? get modelCategory; bool get isIndexingAssetBrowser;
...
bool operator ==(Object other) {
  final _this = this as Unp4kcState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Unp4kcState&&(identical(other.startUp, _this.startUp) || other.startUp == _this.startUp)&&const DeepCollectionEquality().equals(other.files, _this.files)&&(identical(other.fs, _this.fs) || other.fs == _this.fs)&&(identical(other.curPath, _this.curPath) || other.curPath == _this.curPath)&&(identical(other.endMessage, _this.endMessage) || other.endMessage == _this.endMessage)&&(identical(other.tempOpenFile, _this.tempOpenFile) || other.tempOpenFile == _this.tempOpenFile)&&(identical(other.currentPreviewPath, _this.currentPreviewPath) || other.currentPreviewPath == _this.currentPreviewPath)&&(identical(other.errorMessage, _this.errorMessage) || other.errorMessage == _this.errorMessage)&&(identical(other.loadingCurrent, _this.loadingCurrent) || other.loadingCurrent == _this.loadingCurrent)&&(identical(other.loadingTotal, _this.loadingTotal) || other.loadingTotal == _this.loadingTotal)&&(identical(other.searchQuery, _this.searchQuery) || other.searchQuery == _this.searchQuery)&&const DeepCollectionEquality().equals(other.availableSuffixes, _this.availableSuffixes)&&(identical(other.isSearching, _this.isSearching) || other.isSearching == _this.isSearching)&&(identical(other.searchFs, _this.searchFs) || other.searchFs == _this.searchFs)&&const DeepCollectionEquality().equals(other.searchMatchedFiles, _this.searchMatchedFiles)&&const DeepCollectionEquality().equals(other.searchKeptDirectories, _this.searchKeptDirectories)&&(identical(other.isGlobalSearchScope, _this.isGlobalSearchScope) || other.isGlobalSearchScope == _this.isGlobalSearchScope)&&(identical(other.searchPath, _this.searchPath) || other.searchPath == _this.searchPath)&&(identical(other.sortType, _this.sortType) || other.sortType == _this.sortType)&&(identical(other.isMultiSelectMode, _this.isMultiSelectMode) || other.isMultiSelectMode == _this.isMultiSelectMode)&&const DeepCollectionEquality().equals(other.selectedItems, _this.selectedItems)&&(identical(other.sizeFilterMode, _this.sizeFilterMode) || other.sizeFilterMode == _this.sizeFilterMode)&&(identical(other.sizeFilterUnit, _this.sizeFilterUnit) || other.sizeFilterUnit == _this.sizeFilterUnit)&&(identical(other.sizeFilterSingleValue, _this.sizeFilterSingleValue) || other.sizeFilterSingleValue == _this.sizeFilterSingleValue)&&(identical(other.sizeFilterRangeStart, _this.sizeFilterRangeStart) || other.sizeFilterRangeStart == _this.sizeFilterRangeStart)&&(identical(other.sizeFilterRangeEnd, _this.sizeFilterRangeEnd) || other.sizeFilterRangeEnd == _this.sizeFilterRangeEnd)&&(identical(other.dateFilterMode, _this.dateFilterMode) || other.dateFilterMode == _this.dateFilterMode)&&(identical(other.dateFilterSingleDate, _this.dateFilterSingleDate) || other.dateFilterSingleDate == _this.dateFilterSingleDate)&&(identical(other.dateFilterRangeStart, _this.dateFilterRangeStart) || other.dateFilterRangeStart == _this.dateFilterRangeStart)&&(identical(other.dateFilterRangeEnd, _this.dateFilterRangeEnd) || other.dateFilterRangeEnd == _this.dateFilterRangeEnd)&&const DeepCollectionEquality().equals(other.suffixFilter, _this.suffixFilter)&&(identical(other.viewMode, _this.viewMode) || other.viewMode == _this.viewMode)&&(identical(other.modelCategory, _this.modelCategory) || other.modelCategory == _this.modelCategory)&&(identical(other.isIndexingAssetBrowser, _this.isIndexingAssetBrowser) || other.isIndexingAssetBrowser == _this.isIndexingAssetBrowser));
}
...
int get hashCode {
  final _this = this as Unp4kcState;
  return Object.hashAll([runtimeType,_this.startUp,const DeepCollectionEquality().hash(_this.files),_this.fs,_this.curPath,_this.endMessage,_this.tempOpenFile,_this.currentPreviewPath,_this.errorMessage,_this.loadingCurrent,_this.loadingTotal,_this.searchQuery,const DeepCollectionEquality().hash(_this.availableSuffixes),_this.isSearching,_this.searchFs,const DeepCollectionEquality().hash(_this.searchMatchedFiles),const DeepCollectionEquality().hash(_this.searchKeptDirectories),_this.isGlobalSearchScope,_this.searchPath,_this.sortType,_this.isMultiSelectMode,const DeepCollectionEquality().hash(_this.selectedItems),_this.sizeFilterMode,_this.sizeFilterUnit,_this.sizeFilterSingleValue,_this.sizeFilterRangeStart,_this.sizeFilterRangeEnd,_this.dateFilterMode,_this.dateFilterSingleDate,_this.dateFilterRangeStart,_this.dateFilterRangeEnd,const DeepCollectionEquality().hash(_this.suffixFilter),_this.viewMode,_this.modelCategory,_this.isIndexingAssetBrowser]);
}

@override
String toString() {
  final _this = this as Unp4kcState;
  return 'Unp4kcState(startUp: ${_this.startUp}, files: ${_this.files}, fs: ${_this.fs}, curPath: ${_this.curPath}, endMessage: ${_this.endMessage}, tempOpenFile: ${_this.tempOpenFile}, currentPreviewPath: ${_this.currentPreviewPath}, errorMessage: ${_this.errorMessage}, loadingCurrent: ${_this.loadingCurrent}, loadingTotal: ${_this.loadingTotal}, searchQuery: ${_this.searchQuery}, availableSuffixes: ${_this.availableSuffixes}, isSearching: ${_this.isSearching}, searchFs: ${_this.searchFs}, searchMatchedFiles: ${_this.searchMatchedFiles}, searchKeptDirectories: ${_this.searchKeptDirectories}, isGlobalSearchScope: ${_this.isGlobalSearchScope}, searchPath: ${_this.searchPath}, sortType: ${_this.sortType}, isMultiSelectMode: ${_this.isMultiSelectMode}, selectedItems: ${_this.selectedItems}, sizeFilterMode: ${_this.sizeFilterMode}, sizeFilterUnit: ${_this.sizeFilterUnit}, sizeFilterSingleValue: ${_this.sizeFilterSingleValue}, sizeFilterRangeStart: ${_this.sizeFilterRangeStart}, sizeFilterRangeEnd: ${_this.sizeFilterRangeEnd}, dateFilterMode: ${_this.dateFilterMode}, dateFilterSingleDate: ${_this.dateFilterSingleDate}, dateFilterRangeStart: ${_this.dateFilterRangeStart}, dateFilterRangeEnd: ${_this.dateFilterRangeEnd}, suffixFilter: ${_this.suffixFilter}, viewMode: ${_this.viewMode}, modelCategory: ${_this.modelCategory}, isIndexingAssetBrowser: ${_this.isIndexingAssetBrowser})';
}
...
as DateTime?,suffixFilter: null == suffixFilter ? _self.suffixFilter : suffixFilter // ignore: cast_nullable_to_non_nullable
as Set<String>,viewMode: null == viewMode ? _self.viewMode : viewMode // ignore: cast_nullable_to_non_nullable
as Unp4kViewMode,modelCategory: freezed == modelCategory ? _self.modelCategory : modelCategory // ignore: cast_nullable_to_non_nullable
as Unp4kModelCategory?,isIndexingAssetBrowser: null == isIndexingAssetBrowser ? _self.isIndexingAssetBrowser : isIndexingAssetBrowser // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _Unp4kcState implements Unp4kcState {
  const _Unp4kcState({required this.startUp,  Map<String, AppUnp4kP4kItemData>? files, this.fs, required this.curPath, this.endMessage, this.tempOpenFile, this.currentPreviewPath, this.errorMessage = "", this.loadingCurrent = 0, this.loadingTotal = 0, this.searchQuery = "",  List<String> availableSuffixes = const <String>[], this.isSearching = false, this.searchFs,  Set<String>? searchMatchedFiles,  Set<String>? searchKeptDirectories, this.isGlobalSearchScope = false, this.searchPath, this.sortType = Unp4kSortType.defaultSort, this.isMultiSelectMode = false,  Set<String> selectedItems = const {}, this.sizeFilterMode = Unp4kFilterMode.none, this.sizeFilterUnit = Unp4kSizeUnit.mb, this.sizeFilterSingleValue, this.sizeFilterRangeStart, this.sizeFilterRangeEnd, this.dateFilterMode = Unp4kFilterMode.none, this.dateFilterSingleDate, this.dateFilterRangeStart, this.dateFilterRangeEnd,  Set<String> suffixFilter = const {}, this.viewMode = Unp4kViewMode.fileBrowser, this.modelCategory, this.isIndexingAssetBrowser = false}): _files = files,_availableSuffixes = availableSuffixes,_searchMatchedFiles = searchMatchedFiles,_searchKeptDirectories = searchKeptDirectories,_selectedItems = selectedItems,_suffixFilter = suffixFilter;
...
/// 后缀筛选（多选）
 final  Set<String> _suffixFilter;
/// 后缀筛选（多选）
@override@JsonKey() Set<String> get suffixFilter {
  if (_suffixFilter is EqualUnmodifiableSetView) return _suffixFilter;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_suffixFilter);
}

@override@JsonKey() final  Unp4kViewMode viewMode;
@override final  Unp4kModelCategory? modelCategory;
@override@JsonKey() final  bool isIndexingAssetBrowser;
...
as DateTime?,dateFilterRangeStart: freezed == dateFilterRangeStart ? _self.dateFilterRangeStart : dateFilterRangeStart // ignore: cast_nullable_to_non_nullable
as DateTime?,dateFilterRangeEnd: freezed == dateFilterRangeEnd ? _self.dateFilterRangeEnd : dateFilterRangeEnd // ignore: cast_nullable_to_non_nullable
as DateTime?,suffixFilter: null == suffixFilter ? _self._suffixFilter : suffixFilter // ignore: cast_nullable_to_non_nullable
as Set<String>,viewMode: null == viewMode ? _self.viewMode : viewMode // ignore: cast_nullable_to_non_nullable
as Unp4kViewMode,modelCategory: freezed == modelCategory ? _self.modelCategory : modelCategory // ignore: cast_nullable_to_non_nullable
as Unp4kModelCategory?,isIndexingAssetBrowser: null == isIndexingAssetBrowser ? _self.isIndexingAssetBrowser : isIndexingAssetBrowser // ignore: cast_nullable_to_non_nullable
as bool,
