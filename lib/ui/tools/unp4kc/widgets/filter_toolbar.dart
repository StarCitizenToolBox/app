...
class FilterToolbar extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    bool hasAnyFilter() => hasActiveSizeFilter() || hasActiveDateFilter();
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 4),
          _SuffixQuickSelect(searchController: searchController, model: model),
          const SizedBox(width: 8),
          _FilterPopupButton(
...
class _SuffixQuickSelect extends HookWidget {
  final TextEditingController searchController;
  final Unp4kCModel model;
        ...
        child: GestureDetector(
          onTap: () {
            flyoutController.showFlyout(
              ...
              barrierColor: Colors.transparent,
              builder: (context) => _SuffixQuickSelectPanel(
                searchController: searchController,
                model: model,
              ),
            );
...
class _SuffixQuickSelectPanel extends HookWidget {
  final TextEditingController searchController;
  final Unp4kCModel model;
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 4,
            runSpacing: 4,
            children: _previewFormats.map((suffix) {
              return Button(
                style: ButtonStyle(
                ...
                onPressed: () {
                  ...
                  searchController.text = escaped;
                  model.search(escaped);
                  Navigator.of(context).pop();
                },
                child: Text(suffix, style: const TextStyle(fontSize: 11)),
              );
            }).toList(),
          ),
          ...
          Wrap(
            spacing: 4,
            runSpacing: 4,
            children: _commonFormats.map((suffix) {
              return Button(
                style: ButtonStyle(
                  padding: WidgetStateProperty.all(
                    const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
