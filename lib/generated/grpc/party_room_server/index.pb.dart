...
class BaseRespData extends $pb.GeneratedMessage {
  ...
  factory BaseRespData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BaseRespData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BaseRespData',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BaseRespData copyWith(void Function(BaseRespData) updates) =>
      super.copyWith((message) => updates(message as BaseRespData))
          as BaseRespData;
  ...
  static $pb.PbList<BaseRespData> createRepeated() =>
      $pb.PbList<BaseRespData>();
  @$core.pragma('dart2js:noInline')
  static BaseRespData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BaseRespData>(create);
...
class BasePageRespData extends $pb.GeneratedMessage {
  ...
  factory BasePageRespData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BasePageRespData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BasePageRespData',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ..aOB(3, _omitFieldNames ? '' : 'hasNext', protoName: 'hasNext')
    ..a<$fixnum.Int64>(
        4, _omitFieldNames ? '' : 'curPageNum', $pb.PbFieldType.OU6,
        protoName: 'curPageNum', defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BasePageRespData copyWith(void Function(BasePageRespData) updates) =>
      super.copyWith((message) => updates(message as BasePageRespData))
          as BasePageRespData;
  ...
  static $pb.PbList<BasePageRespData> createRepeated() =>
      $pb.PbList<BasePageRespData>();
  @$core.pragma('dart2js:noInline')
  static BasePageRespData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BasePageRespData>(create);
...
class PingData extends $pb.GeneratedMessage {
  ...
  PingData._() : super();
  factory PingData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PingData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PingData',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'data')
    ..a<$fixnum.Int64>(
        2, _omitFieldNames ? '' : 'clientVersion', $pb.PbFieldType.OS6,
        protoName: 'clientVersion', defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        3, _omitFieldNames ? '' : 'serverVersion', $pb.PbFieldType.OS6,
        protoName: 'serverVersion', defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PingData copyWith(void Function(PingData) updates) =>
      super.copyWith((message) => updates(message as PingData)) as PingData;
  ...
  @$core.pragma('dart2js:noInline')
  static PingData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PingData>(create);
  ...
  @$pb.TagNumber(2)
  set clientVersion($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set serverVersion($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class RoomTypesData extends $pb.GeneratedMessage {
  ...
  factory RoomTypesData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomTypesData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomTypesData',
      createEmptyInstance: create)
    ..pc<RoomType>(1, _omitFieldNames ? '' : 'roomTypes', $pb.PbFieldType.PM,
        protoName: 'roomTypes', subBuilder: RoomType.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomTypesData copyWith(void Function(RoomTypesData) updates) =>
      super.copyWith((message) => updates(message as RoomTypesData))
          as RoomTypesData;
  ...
  static $pb.PbList<RoomTypesData> createRepeated() =>
      $pb.PbList<RoomTypesData>();
  @$core.pragma('dart2js:noInline')
  static RoomTypesData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomTypesData>(create);
...
class RoomType extends $pb.GeneratedMessage {
  ...
  RoomType._() : super();
  factory RoomType.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomType.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomType',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'icon')
    ..aOS(4, _omitFieldNames ? '' : 'desc')
    ..pc<RoomSubtype>(5, _omitFieldNames ? '' : 'subTypes', $pb.PbFieldType.PM,
        protoName: 'subTypes', subBuilder: RoomSubtype.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomType copyWith(void Function(RoomType) updates) =>
      super.copyWith((message) => updates(message as RoomType)) as RoomType;
  ...
  @$core.pragma('dart2js:noInline')
  static RoomType getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RoomType>(create);
...
class RoomSubtype extends $pb.GeneratedMessage {
  ...
  RoomSubtype._() : super();
  factory RoomSubtype.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomSubtype.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomSubtype',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomSubtype copyWith(void Function(RoomSubtype) updates) =>
      super.copyWith((message) => updates(message as RoomSubtype))
          as RoomSubtype;
  ...
  @$core.pragma('dart2js:noInline')
  static RoomSubtype getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomSubtype>(create);
...
class RoomData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomData',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'roomTypeID', protoName: 'roomTypeID')
    ..pPS(3, _omitFieldNames ? '' : 'roomSubTypeIds',
        protoName: 'roomSubTypeIds')
    ..aOS(4, _omitFieldNames ? '' : 'owner')
    ..a<$core.int>(5, _omitFieldNames ? '' : 'maxPlayer', $pb.PbFieldType.O3,
        protoName: 'maxPlayer')
    ..aInt64(6, _omitFieldNames ? '' : 'createTime', protoName: 'createTime')
    ..a<$core.int>(7, _omitFieldNames ? '' : 'curPlayer', $pb.PbFieldType.O3,
        protoName: 'curPlayer')
    ..e<RoomStatus>(8, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: RoomStatus.All,
        valueOf: RoomStatus.valueOf,
  ...
  RoomData copyWith(void Function(RoomData) updates) =>
      super.copyWith((message) => updates(message as RoomData)) as RoomData;
...
class RoomListPageReqData extends $pb.GeneratedMessage {
  ...
  factory RoomListPageReqData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomListPageReqData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomListPageReqData',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'typeID', protoName: 'typeID')
    ..aOS(2, _omitFieldNames ? '' : 'subTypeID', protoName: 'subTypeID')
    ..e<RoomStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: RoomStatus.All,
        valueOf: RoomStatus.valueOf,
        enumValues: RoomStatus.values)
    ..e<RoomSortType>(4, _omitFieldNames ? '' : 'sort', $pb.PbFieldType.OE,
        defaultOrMaker: RoomSortType.Default,
        valueOf: RoomSortType.valueOf,
        enumValues: RoomSortType.values)
    ..a<$fixnum.Int64>(5, _omitFieldNames ? '' : 'pageNum', $pb.PbFieldType.OU6,
        protoName: 'pageNum', defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomListPageReqData copyWith(void Function(RoomListPageReqData) updates) =>
      super.copyWith((message) => updates(message as RoomListPageReqData))
  ...
  static $pb.PbList<RoomListPageReqData> createRepeated() =>
      $pb.PbList<RoomListPageReqData>();
  @$core.pragma('dart2js:noInline')
  static RoomListPageReqData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomListPageReqData>(create);
...
class RoomListData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomListData',
      createEmptyInstance: create)
    ..aOM<BasePageRespData>(1, _omitFieldNames ? '' : 'pageData',
        protoName: 'pageData', subBuilder: BasePageRespData.create)
    ..pc<RoomData>(2, _omitFieldNames ? '' : 'rooms', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(1)
  set pageData(BasePageRespData v) {
    setField(1, v);
  }
...
class PreUser extends $pb.GeneratedMessage {
  ...
  PreUser copyWith(void Function(PreUser) updates) =>
      super.copyWith((message) => updates(message as PreUser)) as PreUser;
...
class RoomUserData extends $pb.GeneratedMessage {
  ...
  factory RoomUserData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomUserData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomUserData',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'playerName', protoName: 'playerName')
    ..aOS(3, _omitFieldNames ? '' : 'Avatar', protoName: 'Avatar')
    ..e<RoomUserStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: RoomUserStatus.RoomUserStatusJoin,
        valueOf: RoomUserStatus.valueOf,
        enumValues: RoomUserStatus.values)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomUserData copyWith(void Function(RoomUserData) updates) =>
      super.copyWith((message) => updates(message as RoomUserData))
          as RoomUserData;
  ...
  static $pb.PbList<RoomUserData> createRepeated() =>
      $pb.PbList<RoomUserData>();
  @$core.pragma('dart2js:noInline')
  static RoomUserData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomUserData>(create);
...
class RoomUpdateMessage extends $pb.GeneratedMessage {
  ...
  factory RoomUpdateMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RoomUpdateMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RoomUpdateMessage',
      createEmptyInstance: create)
    ..aOM<RoomData>(1, _omitFieldNames ? '' : 'roomData',
        protoName: 'roomData', subBuilder: RoomData.create)
    ..pc<RoomUserData>(
        2, _omitFieldNames ? '' : 'usersData', $pb.PbFieldType.PM,
        protoName: 'usersData', subBuilder: RoomUserData.create)
    ..e<RoomUpdateType>(
        3, _omitFieldNames ? '' : 'roomUpdateType', $pb.PbFieldType.OE,
        protoName: 'roomUpdateType',
        defaultOrMaker: RoomUpdateType.RoomUpdateData,
        valueOf: RoomUpdateType.valueOf,
        enumValues: RoomUpdateType.values)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RoomUpdateMessage copyWith(void Function(RoomUpdateMessage) updates) =>
      super.copyWith((message) => updates(message as RoomUpdateMessage))
  ...
  static $pb.PbList<RoomUpdateMessage> createRepeated() =>
      $pb.PbList<RoomUpdateMessage>();
  @$core.pragma('dart2js:noInline')
  static RoomUpdateMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RoomUpdateMessage>(create);
  static RoomUpdateMessage? _defaultInstance;

  @$pb.TagNumber(1)
  RoomData get roomData => $_getN(0);
  @$pb.TagNumber(1)
  set roomData(RoomData v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set roomUpdateType(RoomUpdateType v) {
    setField(3, v);
  }
