...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m83(v0, v1) => "您在清晨 ${v0} 月 ${v1} 日開始了星際之旅";

  static String m84(v0, v1) => "深夜 ${v0} 月 ${v1} 日還在探索宇宙";

  static String m85(v0) => "${v0} 次";

  static String m86(v0) => "${v0}月";

  static String m87(v0) => "僅啟動 ${v0} 次";

  static String m88(v0) => "啟動了 ${v0} 次";
