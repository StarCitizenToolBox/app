...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m46(v0) => "快取大小 ${v0}MB，清除盒子下載的翻譯文件快取，不會影響已安裝的翻譯";

  static String m47(v0) =>
      "已設定的核心數量：${v0}   （此功能適用於首頁的盒子快速啟動 或 工具中的RSI啟動器管理員模式，當為 0 時不啟用此功能 ）";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "home_action_info_web_localization_plugin_disclaimer":
            MessageLookupByLibrary.simpleMessage(
                "本插功能件僅供大致瀏覽使用，不對任何有關本功能產生的問題負責！在涉及帳號操作前請注意確認網站的原本內容！\n\n\n使用此功能登錄帳號時請確保您的 SC漢化盒子 是從可信任的來源下載。"),
