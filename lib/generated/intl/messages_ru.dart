...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(v0) =>
      "Не удалось восстановить базу данных: ${v0}\n\nЗакройте антивирус и другие программы, которые могут использовать файлы, и повторите попытку. Если не помогает, сбросьте приложение в параметрах Windows.";

  static String m3(v0) =>
      "${v0}\n\nЕсли проблема повторяется, попробуйте восстановить базу данных.";

  static String m4(v0) => "Не удалось преобразовать DDS в PNG: ${v0}";

  static String m5(v0) => "DDS успешно преобразован в PNG: ${v0}";

  static String m6(v0, v1) => "SCToolbox V${v0} ${v1}";

  static String m7(v0) => "Ошибка инициализации: ${v0}";

  static String m8(v0) => "Путь не существует: ${v0}";

  static String m9(v0) => "[Воспроизвести видео](${v0})";
  ...
  static String m11(v0) => "Введите ${v0}";

  static String m12(v0) => "Загрузка: ${v0}%    ";

  static String m13(v0) => "Найдена новая версия -> ${v0}";

  static String m14(v0) => "Не удалось сгенерировать код авторизации: ${v0}.";

  static String m15(v0) => "Не удалось открыть браузер: ${v0}.";

  static String m16(v0) => "Не удалось инициализировать: ${v0}.";

  static String m17(v0) => "Это действие позволит ${v0}:";

  static String m21(v0) => "Аварийное завершение игры: ${v0}";

  static String m22(v0) =>
      "инфо:${v0}, пожалуйста, нажмите в правом нижнем углу, чтобы присоединиться к группе для обратной связи.";

  static String m23(v0) => "Анализ завершен, обнаружено ${v0} проблем";

  static String m24(v0, v1) =>
      "Не удалось создать папку, попробуйте создать её вручную.\nПуть: ${v0}\nОшибка: ${v1}";

  static String m25(v0) => "Исправление не удалось, ${v0}";

  static String m26(v0) => "Неподдерживаемая операционная система: ${v0}";
  ...
  static String m30(v0) => "Предложение по исправлению: ${v0}";

  static String m31(v0) =>
      "Вам нужно как минимум 16 ГБ физической памяти (RAM) для запуска этой игры. (Текущий размер: ${v0})";

  static String m32(v0) => "Пожалуйста, обновите вашу систему (${v0})";

  static String m33(v0) => "Быстрая диагностика -> ${v0}";

  static String m34(v0) => "Проверено: ${v0}";

  static String m35(v0) => "Проверка... (${v0}%)";

  static String m36(v0, v1) => "Загрузка: ${v0}/с    Отдача: ${v1}/с";

  static String m37(v0) => "Загружено: ${v0}";

  static String m38(v0) => "Загрузка... (${v0}%)";

  static String m39(v0) => "Статус: ${v0}";

  static String m40(v1) => "Общий размер: ${v1}";

  static String m41(v0) => "Отдано: ${v0}";

  static String m42(v0, v1, v2, v3, v4) =>
  ...
  static String m45(v0) => "${v0} дней";

  static String m46(v0) => "Загруженная версия локализации: ${v0}";

  static String m47(v0) => "Расширенная локализация -> ${v0}";

  static String m48(v0, v1) => "Строк локализации: ${v0} Строк P4K: ${v1}";

  static String m49(v0) => "Предпросмотр: ${v0}";

  static String m50(v0) =>
      "Доступна новая версия локализации, установленной ${v0}!";

  static String m51(v1, v2) =>
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_common_operation_failed": MessageLookupByLibrary.simpleMessage(
    ...
    "app_db_repair_confirm": MessageLookupByLibrary.simpleMessage(
      "Кэш загрузок будет очищен, а база настроек пересоздана. Ваши настройки сохранятся. Продолжить?",
    ),
    "app_db_repair_done": MessageLookupByLibrary.simpleMessage(
      "База данных восстановлена. Повторите действие.",
    ),
    "app_db_repair_failed": m2,
    "app_db_repair_hint": m3,
    "app_dds_to_png_failed": m4,
    "app_dds_to_png_successful": m5,
    ...
    "app_index_version_info": m6,
    "app_init_failed_with_reason": m7,
    ...
    "app_splash_free_software_notice_content": m10,
    "app_splash_free_software_notice_input_hint": m11,
    ...
    "app_upgrade_info_downloading": m12,
    ...
    "app_upgrade_title_new_version_found": m13,
    ...
    "auth_initialization_failed": m16,
    ...
    "auth_this_action_will_allow": m17,
    ...
    "doctor_action_result_info_unsupported_os": m26,
    ...
    "doctor_info_result_memory_requirement": m31,
    ...
    "doctor_info_result_upgrade_system": m32,
    ...
    "doctor_title_one_click_diagnosis": m33,
    ...
    "downloader_info_checked": m34,
    "downloader_info_checking": MessageLookupByLibrary.simpleMessage(
      "Проверка",
    ),
    "downloader_info_checking_progress": m35,
    ...
    "downloader_info_download_upload_speed": m36,
    "downloader_info_downloaded": m37,
    "downloader_info_downloading": m38,
    ...
    "downloader_info_status": m39,
    "downloader_info_total_size": m40,
    "downloader_info_uploaded": m41,
    ...
    "home_action_info_abnormal_game_exit": m42,
    ...
    "home_action_info_initialization_failed": m43,
    ...
    "home_action_info_scan_complete_valid_directories_found": m44,
    ...
    "home_holiday_countdown_days": m45,
    ...
    "home_localization_advanced_msg_version": m46,
    "home_localization_advanced_title": m47,
    "home_localization_advanced_title_msg": m48,
    "home_localization_advanced_title_preview": m49,
    ...
    "home_localization_new_version_installed": m50,
    ...
    "home_login_info_rsi_server_report": m51,
    ...
    "settings_item_repair_database": MessageLookupByLibrary.simpleMessage(
      "Восстановить базу данных",
    ),
    "settings_item_repair_database_info": MessageLookupByLibrary.simpleMessage(
      "Используйте, если действия вроде установки локализации ничего не делают: очищает кэш загрузок и пересоздаёт базу настроек, сохраняя ваши настройки",
    ),
