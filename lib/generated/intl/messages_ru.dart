...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m118(v0) => "Открытие файла: ${v0}";

  static String m119(v0, v1) =>
      "Загрузка завершена: ${v0} файлов, время: ${v1} мс";

  static String m120(v0) => "Чтение файла: ${v0}...";

  static String m121(v0, v1) => "Обработка файлов (${v0}/${v1})...";

  static String m122(v0) => "Неизвестный тип файла\n${v0}";

  static String m123(v0) => "Просмотрщик P4K -> ${v0}";

  static String m124(v0) => "Вход выполнен ${v0} раз";

  static String m125(v0) => "Всего обнаружено ${v0} аккаунтов";
  ...
  static String m127(year) => "Ежегодный отчет ${year} (Ограниченное время)";

  static String m128(v0, v1, v2, v3) => "${v0}/${v1} - ${v2}/${v3}";

  static String m129(v0, v1) => "${v0} ч ${v1} мин";

  static String m130(v0) => "${v0} мин";
  ...
  static String m133(v0) => "${v0} раз";

  static String m134(v0) => "Месяц ${v0}";

  static String m135(v0) => "Запущено только ${v0} раз";

  static String m136(v0) => "Запущено ${v0} раз";

  static String m137(v0) => "${v0} часов";

  static String m138(v0, v1) => "${v0}/${v1}";

  static String m139(year) =>
      "В ${year} году мы вместе создали\nбесчисленное количество прекрасных воспоминаний в Star Citizen";

  static String m140(nextYear) => "Ждем встречи с вами в ${nextYear} году!";

  static String m141(year) => "Ежегодный отчет Star Citizen за ${year} год";

  static String m142(v0) => "Уничтожено ${v0} раз";

  static String m143(v0) => "Пилотировался ${v0} раз";

  static String m144(v0) => "Показать все ${v0} тс";

  static String m145(year) => "Ежегодный отчет ${year}";
