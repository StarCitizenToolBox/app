...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(v0) => "Ошибка инициализации: ${v0}";
  ...
  static String m5(v0) => "Введите ${v0}";

  static String m6(v0) => "Загрузка: ${v0}%    ";

  static String m7(v0) => "Найдена новая версия -> ${v0}";

  static String m11(v0) => "Аварийное завершение игры: ${v0}";

  static String m12(v0) =>
      "инфо:${v0}, пожалуйста, нажмите в правом нижнем углу, чтобы присоединиться к группе для обратной связи.";

  static String m13(v0) => "Анализ завершен, обнаружено ${v0} проблем";

  static String m14(v0, v1) =>
      "Не удалось создать папку, попробуйте создать её вручную.\nПуть: ${v0}\nОшибка: ${v1}";

  static String m15(v0) => "Исправление не удалось, ${v0}";

  static String m16(v0) => "Неподдерживаемая операционная система: ${v0}";
  ...
  static String m20(v0) => "Предложение по исправлению: ${v0}";

  static String m21(v0) =>
      "Вам нужно как минимум 16 ГБ физической памяти (RAM) для запуска этой игры. (Текущий размер: ${v0})";

  static String m22(v0) => "Пожалуйста, обновите вашу систему (${v0})";

  static String m23(v0) => "Быстрая диагностика -> ${v0}";

  static String m24(v0) => "Проверено: ${v0}";

  static String m25(v0) => "Проверка... (${v0}%)";

  static String m26(v0, v1) => "Загрузка: ${v0}/с    Отдача: ${v1}/с";

  static String m27(v0) => "Загружено: ${v0}";

  static String m28(v0) => "Загрузка... (${v0}%)";

  static String m29(v0) => "Статус: ${v0}";

  static String m30(v1) => "Общий размер: ${v1}";

  static String m31(v0) => "Отдано: ${v0}";

  static String m32(v0, v1, v2, v3, v4) =>
      "Игра завершилась ненормально\nexitCode=${v0}\nstdout=${v1}\nstderr=${v2}\n\nДиагностическая информация: ${v3}\n${v4}";

  static String m33(v0) =>
  ...
  static String m35(v0) => "${v0} дней";

  static String m36(v0) => "Загруженная версия локализации: ${v0}";

  static String m37(v0) => "Расширенная локализация -> ${v0}";

  static String m38(v0, v1) => "Строк локализации: ${v0} Строк P4K: ${v1}";

  static String m39(v0) => "Предпросмотр: ${v0}";

  static String m40(v0) =>
      "Доступна новая версия локализации, установленной ${v0}!";

  static String m41(v1, v2) =>
      "Сервер RSI сообщает версию: ${v1}\n\nЛокальная версия: ${v2}\n\nРекомендуется обновить игру через RSI Launcher!";

  static String m44(v0) => "Поддержка метода ввода сообщества: ${v0}";

  static String m45(v0) =>
      "Поддержка метода ввода сообщества обновлена до версии: ${v0}";

  static String m46(v0, v1) =>
      "${v0} расширений имеют обновления: ${v1}. Пожалуйста, переустановите в управлении локализацией.";

  static String m47(v0, v1) =>
      "${v0} имеет новую версию ${v1}. Пожалуйста, переустановите в управлении локализацией.";

  static String m48(v0) => "Канал: ${v0}";

  static String m49(v0) => "Включено (${v0}):";

  static String m50(v0) => "Ошибка установки!\n\n${v0}";

  static String m51(v0) => "Установленная версия: ${v0}";

  static String m52(v0) => "Время обновления: ${v0}";

  static String m53(v0) => "Номер версии: ${v0}";
  ...
  static String m55(v0, v2, v3) =>
      "ID жертвы: ${v0}   \nID убийцы: ${v2}  \nЗона: ${v3}";

  static String m56(v0) => "Подробная информация: ${v0}";

  static String m57(v0, v1, v2, v3, v4) =>
      "Убийства: ${v0}   Смерти: ${v1}   Самоубийства: ${v2}  \nУничтожение техники (Мягкая смерть): ${v3}   Уничтожение техники (Распад): ${v4}";

  static String m58(v0, v1) => "Режим: ${v0}   Время: ${v1} секунд";

  static String m59(v0, v1, v2) => "${v0} часов ${v1} минут ${v2} секунд";

  static String m60(v0, v1) => "ID игрока: ${v0}   Местоположение: ${v1}";

  static String m61(v0) => "Игрок ${v0} входит в игру...";

  static String m62(v0, v1, v2, v3, v4) =>
      "Модель техники: ${v0}   \nЗона: ${v1} \nУровень повреждения: ${v2} (${v3})   Виновник: ${v4}";

  static String m63(v0) => "Ошибка подключения: ${v0}";

  static String m64(v0) => "${v0} дн. назад";

  static String m65(v0) => "Не удалось выйти из комнаты: ${v0}";

  static String m66(v0) => "Не удалось получить код подтверждения: ${v0}";

  static String m67(v0) => "${v0} ч. назад";

  static String m68(v0) => "Вы уверены, что хотите выгнать ${v0}?";

  static String m69(v0) => "Не удалось выгнать участника: ${v0}";

  static String m70(v0) => "Не удалось загрузить список комнат: ${v0}";

  static String m71(v0, v1) => "${v0}/${v1} участников";

  static String m72(v0) => "${v0} мин. назад";

  static String m73(v0) => "Не удалось переподключиться: ${v0}";

  static String m74(v0) => "Не удалось переподключиться, попыток: ${v0}";

  static String m75(v0) => "Ошибка регистрации: ${v0}";

  static String m76(v0) => "Вы уверены, что хотите передать владение ${v0}?";

  static String m77(v0) => "Не удалось передать владение: ${v0}";

  static String m78(v0) => "Текущий статус: ${v0}";

  static String m79(v0, v1, v2) => "${v0}    Мин.: ${v1} / Макс.: ${v2}";

  static String m80(v0) => "Оптимизация производительности -> ${v0}";
  ...
  static String m84(v0) => "✗ appModel.initApp() ошибка: ${v0}";

  static String m85(v0) => "⚠ aria2cModelProvider ошибка инициализации: ${v0}";

  static String m86(v0) => "⚠ URLConf.checkHost() ошибка: ${v0} - продолжение";

  static String m87(v0) =>
      "⚠ appModel.checkUpdate() ошибка: ${v0} - продолжение";

  static String m88(v0) => "[Диагностика] Не удалось закрыть Hive boxes: ${v0}";
  ...
  static String m91(v0) => "[Диагностика] ${v0}";

  static String m92(v0) => "Режим диагностики - Шаг ${v0}";

  static String m93(v0) => "✗ Hive.openBox(\"app_conf\") ошибка: ${v0}";

  static String m94(v0) => "[${v0}] ⚠ Лог-файл не существует";

  static String m95(v0) =>
      "[${v0}] --- Чтение лога завершено (показаны последние 1000 строк) ---";

  static String m96(v0, v1) => "[${v0}] ✗ Не удалось прочитать лог: ${v1}";

  static String m97(v0) =>
      "[Диагностика] Не удалось сбросить базу данных: ${v0}";

  static String m98(v0) => "[${v0}] Начало инициализации...";

  static String m99(v0) => "[${v0}] --- Начало чтения полного лог-файла ---";

  static String m100(v0) =>
      "Очистка не удалась, пожалуйста, удалите файл вручную, расположение файла: ${v0}";

  static String m101(v0) => "Произошла ошибка: ${v0}";
  ...
  static String m107(v0, v1, v2, v3, v4) =>
      "Система: ${v0}\n\nПроцессор: ${v1}\n\nОбъем памяти: ${v2}GB\n\nИнформация о видеокарте:\n${v3}\n\nИнформация о жестком диске:\n${v4}\n\n";

  static String m110(v0) => "Ошибка обработки: ${v0}";

  static String m111(v0) => "Не удалось прочитать информацию о лаунчере: ${v0}";

  static String m112(v0) => "Статус патча: ${v0}";

  static String m113(v0) => "Внутренняя версия лаунчера: ${v0}";

  static String m123(v0) => "Открытие файла: ${v0}";

  static String m124(v0, v1) =>
      "Загрузка завершена: ${v0} файлов, время: ${v1} мс";

  static String m125(v0) => "Чтение файла: ${v0}...";

  static String m126(v0, v1) => "Обработка файлов (${v0}/${v1})...";

  static String m127(v0) => "Неизвестный тип файла\n${v0}";

  static String m128(v0) => "Просмотрщик P4K -> ${v0}";

  static String m129(v0) => "Вход выполнен ${v0} раз";

  static String m130(v0) => "Всего обнаружено ${v0} аккаунтов";

  static String m131(year) =>
  ...
  static String m132(year) => "Ежегодный отчет ${year} (Ограниченное время)";

  static String m133(v0, v1, v2, v3) => "${v0}/${v1} - ${v2}/${v3}";

  static String m134(v0, v1) => "${v0} ч ${v1} мин";

  static String m135(v0) => "${v0} мин";

  static String m136(v0, v1) =>
  ...
  static String m138(v0) => "${v0} раз";

  static String m139(v0) => "Месяц ${v0}";

  static String m140(v0) => "Запущено только ${v0} раз";

  static String m141(v0) => "Запущено ${v0} раз";

  static String m142(v0) => "${v0} часов";

  static String m143(v0, v1) => "${v0}/${v1}";

  static String m144(year) =>
      "В ${year} году мы вместе создали\nбесчисленное количество прекрасных воспоминаний в Star Citizen";

  static String m145(nextYear) => "Ждем встречи с вами в ${nextYear} году!";

  static String m146(year) => "Ежегодный отчет Star Citizen за ${year} год";

  static String m147(v0) => "Уничтожено ${v0} раз";

  static String m148(v0) => "Пилотировался ${v0} раз";

  static String m149(v0) => "Показать все ${v0} тс";

  static String m150(year) => "Ежегодный отчет ${year}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_splash_free_software_notice_content": m4,
    "app_splash_free_software_notice_input_hint": m5,
    ...
    "app_upgrade_info_downloading": m6,
    ...
    "app_upgrade_title_new_version_found": m7,
    ...
    "doctor_action_result_info_unsupported_os": m16,
    ...
    "doctor_info_result_memory_requirement": m21,
    ...
    "doctor_info_result_upgrade_system": m22,
    ...
    "doctor_title_one_click_diagnosis": m23,
    ...
    "downloader_info_checked": m24,
    "downloader_info_checking": MessageLookupByLibrary.simpleMessage(
      "Проверка",
    ),
    "downloader_info_checking_progress": m25,
    ...
    "downloader_info_download_upload_speed": m26,
    "downloader_info_downloaded": m27,
    "downloader_info_downloading": m28,
    ...
    "downloader_info_status": m29,
    "downloader_info_total_size": m30,
    "downloader_info_uploaded": m31,
    ...
    "home_action_info_abnormal_game_exit": m32,
    ...
    "home_action_info_initialization_failed": m33,
    ...
    "home_action_info_scan_complete_valid_directories_found": m34,
    ...
    "home_holiday_countdown_days": m35,
    ...
    "home_localization_advanced_msg_version": m36,
    "home_localization_advanced_title": m37,
    "home_localization_advanced_title_msg": m38,
    "home_localization_advanced_title_preview": m39,
    ...
    "home_localization_new_version_installed": m40,
    ...
    "home_login_info_rsi_server_report": m41,
    ...
    "input_method_community_input_method_support_version": m44,
    ...
    "input_method_support_updated_to_version": m45,
    ...
    "localization_extension_update_multiple": m46,
    "localization_extension_update_single": m47,
    "localization_info_channel": m48,
    ...
    "localization_info_installation_error": m50,
    "localization_info_installed": MessageLookupByLibrary.simpleMessage(
      "Установлено",
    ),
    "localization_info_installed_version": m51,
    ...
    "localization_info_update_time": m52,
    "localization_info_version_number": m53,
    "log_analyzer_collision_details": m54,
    "log_analyzer_death_details": m55,
    ...
    "log_analyzer_kill_death_suicide_count": m57,
    "log_analyzer_kill_summary": MessageLookupByLibrary.simpleMessage(
      "Сводка убийств",
    ),
    "log_analyzer_mode_loading_time": m58,
    ...
    "log_analyzer_play_time_format": m59,
    "log_analyzer_player_location": m60,
    "log_analyzer_player_login": m61,
    ...
    "log_analyzer_vehicle_damage_details": m62,
    ...
    "party_room_exit_room_failed": m65,
    ...
    "party_room_get_code_failed": m66,
    ...
    "party_room_kick_member_confirm": m68,
    "party_room_kick_member_failed": m69,
    ...
    "party_room_load_list_failed": m70,
    ...
    "party_room_members_count": m71,
    "party_room_minutes_ago": m72,
    ...
    "party_room_transfer_owner_confirm": m76,
    "party_room_transfer_owner_failed": m77,
    ...
    "performance_info_current_status": m78,
    ...
    "performance_info_min_max_values": m79,
    ...
    "performance_title_performance_optimization": m80,
    ...
    "setting_action_info_cache_clearing_info": m81,
    ...
    "setting_action_set_core_count": m82,
    ...
    "splash_deleting_db": m90,
    "splash_diagnostic_log": m91,
    "splash_diagnostic_mode": m92,
    ...
    "splash_log_not_exist": m94,
    "splash_log_read_done": m95,
    ...
    "splash_start_init": m98,
    "splash_start_read_log": m99,
    ...
    "tools_action_info_cleanup_failed": m100,
    ...
    "tools_action_info_error_occurred": m101,
    ...
    "tools_action_info_init_failed": m102,
    ...
    "tools_action_info_nvme_patch_issue": m103,
    ...
    "tools_action_info_p4k_download_repair_tip": m104,
    ...
    "tools_action_info_rsi_launcher_log_issue": m105,
    ...
    "tools_action_info_shader_cache_issue": m106,
    ...
    "tools_action_info_system_info_content": m107,
    ...
    "tools_info_processing_failed": m110,
    ...
    "tools_unp4k_msg_open_file": m123,
    "tools_unp4k_msg_read_completed": m124,
    "tools_unp4k_msg_read_file": m125,
    ...
    "tools_unp4k_msg_reading3": m126,
    "tools_unp4k_msg_unknown_file_type": m127,
    "tools_unp4k_title": m128,
    ...
    "yearly_report_account_count": m129,
    ...
    "yearly_report_duration_hours_minutes": m134,
    "yearly_report_duration_minutes": m135,
    "yearly_report_earliest_play_desc": m136,
    ...
    "yearly_report_latest_play_desc": m137,
    ...
    "yearly_report_launch_count_value": m138,
    ...
    "yearly_report_play_time_value": m142,
    ...
    "yearly_report_session_date": m143,
    ...
    "yearly_report_thanks_message": m144,
    "yearly_report_thanks_next": m145,
    "yearly_report_thanks_title": MessageLookupByLibrary.simpleMessage(
      "Спасибо, что вы с нами",
    ),
    "yearly_report_title": m146,
    "yearly_report_vehicle_destruction_count": m147,
    ...
    "yearly_report_vehicle_pilot_count": m148,
    "yearly_report_vehicle_pilot_expand": m149,
    ...
    "yearly_report_welcome_title": m150,
  };
}
