...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(v0) =>
      "データベースの修復に失敗しました：${v0}\n\nウイルス対策ソフトなど、ファイルを使用している可能性のあるプログラムを閉じてから再試行してください。それでも失敗する場合は、Windows の設定でアプリをリセットしてください。";

  static String m3(v0) => "${v0}\n\nこの問題が繰り返し発生する場合は、データベースの修復をお試しください。";

  static String m4(v0) => "DDS から PNG への変換に失敗しました: ${v0}";

  static String m5(v0) => "DDS から PNG への変換が成功しました: ${v0}";

  static String m6(v0, v1) => "SCToolbox V${v0} ${v1}";

  static String m7(v0) => "初期化に失敗：${v0}";

  static String m8(v0) => "パスが存在しません: ${v0}";

  static String m9(v0) => "[ビデオを再生](${v0})";
  ...
  static String m11(v0) => "入力してください ${v0}";

  static String m12(v0) => "ダウンロード中： ${v0}%    ";

  static String m13(v0) => "新しいバージョンが見つかりました -> ${v0}";

  static String m14(v0) => "認証コードの生成に失敗しました: ${v0}";

  static String m15(v0) => "ブラウザを開けませんでした: ${v0}";

  static String m16(v0) => "初期化に失敗しました: ${v0}";

  static String m17(v0) => "このアクションにより、${v0} が許可されます。";

  static String m21(v0) => "ゲームが異常終了しました：${v0}";

  static String m22(v0) => "info:${v0}、右下の「グループに参加」をクリックしてフィードバックしてください。";

  static String m23(v0) => "分析完了、${v0}個の問題が見つかりました";

  static String m24(v0, v1) =>
      "フォルダの作成に失敗しました。手動で作成してみてください。\nディレクトリ：${v0} \nエラー：${v1}";

  static String m25(v0) => "修復に失敗しました、${v0}";

  static String m26(v0) => "サポートされていないオペレーティングシステム：${v0}";
  ...
  static String m30(v0) => "修正提案： ${v0}";

  static String m31(v0) =>
      "このゲームを実行するには、少なくとも16GBの物理メモリ（RAM）が必要です。（現在のサイズ：${v0}）";

  static String m32(v0) => "システムをアップグレードしてください (${v0})";

  static String m33(v0) => "ワンクリック診断 -> ${v0}";

  static String m34(v0) => "検証済み：${v0}";

  static String m35(v0) => "検証中... (${v0}%)";

  static String m36(v0, v1) => "ダウンロード： ${v0}/s    アップロード：${v1}/s";

  static String m37(v0) => "ダウンロード済み：${v0}";

  static String m38(v0) => "ダウンロード中... (${v0}%)";

  static String m39(v0) => "ステータス：${v0}";

  static String m40(v1) => "合計サイズ：${v1}";

  static String m41(v0) => "アップロード済み：${v0}";

  static String m42(v0, v1, v2, v3, v4) =>
      "ゲームが正常に終了しませんでした\nexitCode=${v0}\nstdout=${v1}\nstderr=${v2}\n\n診断情報：${v3} \n${v4}";

  static String m43(v0) => "ウェブローカリゼーションリソースの初期化に失敗しました！${v0}";

  static String m44(v0) => "スキャン完了、${v0}個の有効なインストールディレクトリが見つかりました";

  static String m45(v0) => "${v0}日  ";

  static String m46(v0) => "読み込まれたローカリゼーションバージョン：${v0}";

  static String m47(v0) => "高度なローカリゼーション -> ${v0}";

  static String m48(v0, v1) => "ローカリゼーションテキスト行数：${v0}  P4Kテキスト行数：${v1}";

  static String m49(v0) => "プレビュー：${v0}";

  static String m50(v0) => "${v0}にインストールしたローカリゼーションに新しいバージョンがあります！";

  static String m51(v1, v2) =>
      "RSIサーバーが報告するバージョン：${v1} \n\nローカルバージョン：${v2} \n\nRSI Launcherを使用してゲームを更新することをお勧めします！";

  static String m54(v0) => "コミュニティ入力メソッドサポート：${v0}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_db_repair_confirm": MessageLookupByLibrary.simpleMessage(
      "ダウンロードキャッシュを削除し、設定データベースを再構築します。設定は保持されます。続行しますか？",
    ),
    "app_db_repair_done": MessageLookupByLibrary.simpleMessage(
      "データベースを修復しました。もう一度お試しください。",
    ),
    ...
    "settings_item_repair_database_info": MessageLookupByLibrary.simpleMessage(
      "ローカライズのインストールなどの操作が反応しない場合に使用します。ダウンロードキャッシュを削除し、設定データベースを再構築します（設定は保持されます）",
    ),
