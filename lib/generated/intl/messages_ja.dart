...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(v0) => "DDS から PNG への変換に失敗しました: ${v0}";

  static String m3(v0) => "DDS から PNG への変換が成功しました: ${v0}";

  static String m4(v0, v1) => "SCToolbox V${v0} ${v1}";

  static String m5(v0) => "初期化に失敗：${v0}";

  static String m6(v0) => "パスが存在しません: ${v0}";

  static String m7(v0) => "[ビデオを再生](${v0})";

  static String m8(v0) =>
      "本アプリケーションはオープンソースの無料ソフトウェアです。いかなる形式の転売も強く非難します。第三者に料金を支払って本ソフトウェアを入手した場合は、直ちに通報し、返金を求めてください。\n\n内容を確認したことを示すため、下に ${v0} と入力してください。";

  static String m9(v0) => "入力してください ${v0}";

  static String m10(v0) => "ダウンロード中： ${v0}%    ";

  static String m11(v0) => "新しいバージョンが見つかりました -> ${v0}";

  static String m12(v0) => "認証コードの生成に失敗しました: ${v0}";

  static String m13(v0) => "ブラウザを開けませんでした: ${v0}";

  static String m14(v0) => "初期化に失敗しました: ${v0}";

  static String m15(v0) => "このアクションにより、${v0} が許可されます。";

  static String m19(v0) => "ゲームが異常終了しました：${v0}";

  static String m20(v0) => "info:${v0}、右下の「グループに参加」をクリックしてフィードバックしてください。";

  static String m21(v0) => "分析完了、${v0}個の問題が見つかりました";

  static String m22(v0, v1) =>
      "フォルダの作成に失敗しました。手動で作成してみてください。\nディレクトリ：${v0} \nエラー：${v1}";

  static String m23(v0) => "修復に失敗しました、${v0}";

  static String m24(v0) => "サポートされていないオペレーティングシステム：${v0}";
  ...
  static String m28(v0) => "修正提案： ${v0}";

  static String m29(v0) =>
      "このゲームを実行するには、少なくとも16GBの物理メモリ（RAM）が必要です。（現在のサイズ：${v0}）";

  static String m30(v0) => "システムをアップグレードしてください (${v0})";

  static String m31(v0) => "ワンクリック診断 -> ${v0}";

  static String m32(v0) => "検証済み：${v0}";

  static String m33(v0) => "検証中... (${v0}%)";

  static String m34(v0, v1) => "ダウンロード： ${v0}/s    アップロード：${v1}/s";

  static String m35(v0) => "ダウンロード済み：${v0}";

  static String m36(v0) => "ダウンロード中... (${v0}%)";

  static String m37(v0) => "ステータス：${v0}";

  static String m38(v1) => "合計サイズ：${v1}";

  static String m39(v0) => "アップロード済み：${v0}";

  static String m40(v0, v1, v2, v3, v4) =>
      "ゲームが正常に終了しませんでした\nexitCode=${v0}\nstdout=${v1}\nstderr=${v2}\n\n診断情報：${v3} \n${v4}";

  static String m41(v0) => "ウェブローカリゼーションリソースの初期化に失敗しました！${v0}";

  static String m42(v0) => "スキャン完了、${v0}個の有効なインストールディレクトリが見つかりました";

  static String m43(v0) => "${v0}日  ";

  static String m44(v0) => "読み込まれたローカリゼーションバージョン：${v0}";

  static String m45(v0) => "高度なローカリゼーション -> ${v0}";

  static String m46(v0, v1) => "ローカリゼーションテキスト行数：${v0}  P4Kテキスト行数：${v1}";

  static String m47(v0) => "プレビュー：${v0}";

  static String m48(v0) => "${v0}にインストールしたローカリゼーションに新しいバージョンがあります！";

  static String m49(v1, v2) =>
      "RSIサーバーが報告するバージョン：${v1} \n\nローカルバージョン：${v2} \n\nRSI Launcherを使用してゲームを更新することをお勧めします！";

  static String m52(v0) => "コミュニティ入力メソッドサポート：${v0}";

  static String m53(v0) => "コミュニティ入力メソッドサポートが更新されました：${v0}";

  static String m54(v0, v1) =>
      "${v0}個の拡張に更新があります：${v1}。ローカライズ管理で再インストールしてください。";

  static String m55(v0, v1) => "${v0}に新バージョン${v1}があります。ローカライズ管理で再インストールしてください。";

  static String m56(v0) => "チャネル：${v0}";

  static String m57(v0) => "有効（${v0}）：";

  static String m58(v0) => "インストールエラー！\n\n ${v0}";

  static String m59(v0) => "インストール済みバージョン：${v0}";

  static String m60(v0) => "更新時間：${v0}";

  static String m61(v0) => "バージョン番号：${v0}";

  static String m62(v0, v1, v2, v3, v4) =>
      "エリア：${v0}   プレイヤー操縦：${v1}   衝突エンティティ：${v2} \n衝突ビークル：${v3}   衝突距離：${v4} ";

  static String m63(v0, v2, v3) => "被害者ID：${v0}    \n位置：${v2}  \nエリア：${v3}";

  static String m64(v0) => "詳細情報：${v0}";

  static String m65(v0, v1, v2, v3, v4) =>
      "キル数：${v0}   デス数：${v1}   自殺回数：${v2}  \n機体破壊（ソフトデス）：${v3}   機体破壊（解体）：${v4}";

  static String m66(v0, v1) => "モード：${v0}   所要時間：${v1}秒";

  static String m67(v0, v1, v2) => "${v0}時間${v1}分${v2}秒";

  static String m68(v0, v1) => "プレイヤーID：${v0}   位置：${v1}";

  static String m69(v0) => "プレイヤー ${v0} ログイン中...";

  static String m70(v0, v1, v2, v3, v4) =>
      "ビークルモデル：${v0}   \nエリア：${v1} \n損傷レベル：${v2} （${v3}）   責任者：${v4}";

  static String m71(v0) => "圧縮サイズ（バイト）：${v0}";

  static String m72(v0) => "現在のソース：${v0}";

  static String m73(v0) => "ミラーに必要なオブジェクトがありません：${v0}。公式サイトへ自動切替しません。";

  static String m74(v0) => "オブジェクト SHA-256：${v0}";

  static String m75(v0) => "ダウンロードに失敗しました。再試行しています: ${v0}";

  static String m76(v0) => "ダウンロード速度: ${v0}";

  static String m77(v0) => "ダウンロード中: ${v0}";

  static String m78(v0) => "EasyAntiCheat の登録に失敗しましたが、非致命的な警告として処理を続行します：${v0}";
  ...
  static String m81(v0) => "失敗: ${v0}";

  static String m82(v0) => "${v0}にインストール";
  ...
  static String m84(v0) => "P4K アップデーターが失敗しました: ${v0}";

  static String m85(v0) => "${v0}（保守的な推定）";

  static String m86(v0) => "ゲームファイルの準備中: ${v0}";

  static String m87(v0, v1) =>
      "リリースバージョン：${v0}\n起動ファイル：${v1}\n\nreleaseInfo を読み込みました。先に「更新量を見積もる」をクリックして、Manifest が正常に解析されるか確認できます。";

  static String m88(v0, v1, v2) => "ステージ ${v0}/${v1}: ${v2}";

  static String m89(v0) =>
      "build_manifest.id の更新に失敗しました。致命的ではない警告として続行されました: ${v0}";

  static String m90(v0) => "アップデート完了: ${v0}";

  static String m91(v0) =>
      "更新された build_manifest.id: RequestedP4ChangeNum=${v0}";

  static String m92(v0) => "P4K エントリ メタデータの更新: ${v0}";

  static String m93(v0) => "検証中: ${v0}";

  static String m94(v0) => "書き込み: ${v0}";

  static String m95(v0) => "ゲームファイルの書き込み: ${v0}";

  static String m96(v0) => "接続に失敗: ${v0}";

  static String m97(v0) => "${v0}日前";

  static String m98(v0) => "ルーム退出に失敗: ${v0}";

  static String m99(v0) => "認証コードの取得に失敗: ${v0}";

  static String m100(v0) => "${v0}時間前";

  static String m101(v0) => "${v0}をキックしてもよろしいですか？";

  static String m102(v0) => "メンバーのキックに失敗: ${v0}";

  static String m103(v0) => "ルームリストの読み込みに失敗: ${v0}";

  static String m104(v0, v1) => "${v0}/${v1} メンバー";

  static String m105(v0) => "${v0}分前";

  static String m106(v0) => "再接続に失敗: ${v0}";

  static String m107(v0) => "再接続に失敗、${v0}回試行済み";

  static String m108(v0) => "登録に失敗: ${v0}";

  static String m109(v0) => "${v0}にオーナー権限を移譲してもよろしいですか？";

  static String m110(v0) => "オーナー権限の移譲に失敗: ${v0}";

  static String m111(v0) => "現在の状態：${v0}";

  static String m112(v0, v1, v2) => "${v0}    最小値: ${v1} / 最大値: ${v2}";

  static String m113(v0) => "パフォーマンス最適化 -> ${v0}";
  ...
  static String m116(v0) => "⚠ AnalyticsApi.touch(\"launch\") エラー: ${v0} - 続行";

  static String m117(v0) => "✗ appModel.initApp() エラー: ${v0}";

  static String m118(v0) => "⚠ aria2cModelProvider 初期化エラー: ${v0}";

  static String m119(v0) => "⚠ URLConf.checkHost() エラー: ${v0} - 続行";

  static String m120(v0) => "⚠ appModel.checkUpdate() エラー: ${v0} - 続行";

  static String m121(v0) => "[診断] Hive boxesを閉じることに失敗: ${v0}";

  static String m122(v0) => "[診断] データベースディレクトリが存在しません: ${v0}";

  static String m123(v0) => "[診断] データベースディレクトリを削除中: ${v0}";

  static String m124(v0) => "[診断] ${v0}";

  static String m125(v0) => "診断モード - ステップ ${v0}";

  static String m126(v0) => "✗ Hive.openBox(\"app_conf\") エラー: ${v0}";

  static String m127(v0) => "[${v0}] ⚠ ログファイルが存在しません";

  static String m128(v0) => "[${v0}] --- ログ読み取り完了 (最後の1000行を表示) ---";

  static String m129(v0, v1) => "[${v0}] ✗ ログ読み取りに失敗: ${v1}";

  static String m130(v0) => "[診断] データベースリセットに失敗: ${v0}";

  static String m131(v0) => "[${v0}] 初期化を開始...";

  static String m132(v0) => "[${v0}] --- 完全なログファイルの読み取りを開始 ---";

  static String m133(v0) => "クリーンアップに失敗しました。手動で削除してください。ファイルの場所：${v0}";

  static String m134(v0) => "エラーが発生しました：${v0}";

  static String m135(v0) => "初期化に失敗しました。スクリーンショットを撮って開発者に報告してください。${v0}";
  ...
  static String m143(v0) => "処理に失敗しました！：${v0}";

  static String m144(v0) => "ランチャー情報の読み込みに失敗：${v0}";

  static String m145(v0) => "パッチ状態：${v0}";

  static String m146(v0) => "ランチャー内部バージョン情報：${v0}";

  static String m152(v0) => "オーディオのデコードに失敗しました: ${v0}";

  static String m153(v0) => "音声プレビューに失敗しました: ${v0}";

  static String m154(v0) => "バッファ済みの範囲にのみ移動できます（現在 ${v0} 秒までバッファ済み）";

  static String m156(v0, v1) => "エクスポート完了：成功 ${v0} 件、スキップ ${v1} 件";

  static String m157(v0) => "エクスポート完了：合計 ${v0} ファイル";

  static String m161(v0) => "${v0}\n(キャッシュから)";

  static String m162(v0, v1) => "${v0}\n失敗したファイルがほかに ${v1} 件スキップされました";

  static String m163(v0) => "ファイルを開く：${v0}";

  static String m164(v0, v1) => "読み込み完了：${v0}ファイル、所要時間：${v1} ms";

  static String m165(v0) => "ファイルを読み込み中：${v0}...";

  static String m166(v0, v1) => "ファイルを処理中(${v0}/${v1})...";

  static String m167(v0) => "不明なファイルタイプ\n${v0}";

  static String m168(v0, v1) => "進行状況: ${v0}/${v1}";
  ...
  static String m170(v0) => "P4Kビューア -> ${v0}";

  static String m171(v0) => "ログアウトに失敗しました: ${v0}";

  static String m172(v0) => "更新に失敗しました: ${v0}";

  static String m173(v0) => "登録時刻: ${v0}";

  static String m174(v0) => "${v0} 回ログイン";

  static String m175(v0) => "合計 ${v0} アカウントを検出";

  static String m176(year) =>
      "${year}年のStar Citizenプレイ統計を表示します。データはローカルログからのものです。メインのコンピュータで確認してください。";

  static String m177(year) => "${year} 年間レポート（期間限定）";

  static String m178(v0, v1, v2, v3) => "${v0}月${v1}日 - ${v2}月${v3}日";

  static String m179(v0, v1) => "${v0} 時間 ${v1} 分";

  static String m180(v0) => "${v0} 分";

  static String m181(v0, v1) => "あなたは ${v0}月${v1}日 の夜明けに宇宙の旅を始めました";

  static String m182(v0, v1) => "${v0}月${v1}日 の深夜、あなたはまだ宇宙を探索していました";

  static String m183(v0) => "${v0} 回";

  static String m184(v0) => "${v0}月";

  static String m185(v0) => "わずか ${v0} 回起動";

  static String m186(v0) => "${v0} 回起動";

  static String m187(v0) => "${v0} 時間";
  ...
  static String m190(nextYear) => "${nextYear} 年もよろしくお願いします！";

  static String m191(year) => "Star Citizen ${year} 年間レポート";

  static String m192(v0) => "${v0} 回破壊";

  static String m193(v0) => "${v0} 回操縦";

  static String m194(v0) => "全 ${v0} 車両を表示";

  static String m195(year) => "${year} 年間レポート";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "about_analytics_units_user": MessageLookupByLibrary.simpleMessage("名"),
    ...
    "app_discovered_installation_directories":
        MessageLookupByLibrary.simpleMessage("検出されたインストールディレクトリ"),
    "app_equip_character": MessageLookupByLibrary.simpleMessage("キャラクター装備"),
    "app_fps_weapons": MessageLookupByLibrary.simpleMessage("FPS武器"),
    ...
    "app_open_the_original_text": MessageLookupByLibrary.simpleMessage("原文を開く"),
    "app_path_does_not_exist": m6,
    "app_play_video": m7,
    "app_please_close_the_game_before_updating_p4k_game_files":
        MessageLookupByLibrary.simpleMessage("P4K/ゲームファイルを更新する前にゲームを閉じてください"),
    "app_prop_scene": MessageLookupByLibrary.simpleMessage("小道具シーン"),
    "app_select_game_download_directory": MessageLookupByLibrary.simpleMessage(
      "ゲームのダウンロード ディレクトリを選択します",
    ),
    ...
    "app_skip_ddna_dds_this_type_does_not_preview_decoding":
        MessageLookupByLibrary.simpleMessage(
          "Skip _ddna DDS: このタイプはデコードをプレビューしません",
        ),
    "app_spaceship": MessageLookupByLibrary.simpleMessage("宇宙船"),
    ...
    "app_splash_free_software_notice_confirm":
        MessageLookupByLibrary.simpleMessage("続行"),
    "app_splash_free_software_notice_confirm_text":
        MessageLookupByLibrary.simpleMessage("これは無料ソフトウェアです"),
    ...
    "app_the_web_login_resource_has_not_been_initialized_please_try_again":
        MessageLookupByLibrary.simpleMessage(
          "Web ログイン リソースが初期化されていません。後でもう一度試してください。",
        ),
    "app_there_is_currently_no_data_p4k_available_out_of_the_box_please_s":
        MessageLookupByLibrary.simpleMessage(
          "現在、そのまま使用できる Data.p4k はありません。不完全なインストール ディレクトリを選択するか、ダウンロードする新しいインストール場所を選択してください。",
        ),
    "app_unable_to_read_releaseinfo_from_rsi_return_data":
        MessageLookupByLibrary.simpleMessage(
          "RSI 戻りデータから releaseInfo を読み取ることができません",
        ),
    ...
    "auth_allow": MessageLookupByLibrary.simpleMessage("許可"),
    "auth_authorization_link_copied_to_clipboard":
        MessageLookupByLibrary.simpleMessage("認証リンクがクリップボードにコピーされました"),
    "auth_certified": MessageLookupByLibrary.simpleMessage("認定済み"),
    "auth_failed_to_generate_authorization_code":
        MessageLookupByLibrary.simpleMessage("認証コードの生成に失敗しました"),
    "auth_failed_to_generate_authorization_code_2": m12,
    "auth_failed_to_generate_authorization_link":
        MessageLookupByLibrary.simpleMessage("認証リンクの生成に失敗しました"),
    "auth_failed_to_open_browser": m13,
    "auth_failed_to_open_the_browser_please_copy_the_link_to_access_manual":
        MessageLookupByLibrary.simpleMessage(
          "ブラウザを開けませんでした。リンクをコピーして手動でアクセスしてください",
        ),
    "auth_go_to_login": MessageLookupByLibrary.simpleMessage("ログインに移動"),
    ...
    "auth_missing_callback_address_parameter":
        MessageLookupByLibrary.simpleMessage("コールバックアドレスパラメータがありません"),
    "auth_missing_state_parameter": MessageLookupByLibrary.simpleMessage(
      "状態パラメータがありません",
    ),
    "auth_not_verified": MessageLookupByLibrary.simpleMessage("未検証"),
    "auth_reject": MessageLookupByLibrary.simpleMessage("拒否"),
    ...
    "auth_unable_to_resolve_domain_name_from_callback_address":
        MessageLookupByLibrary.simpleMessage("コールバック アドレスからドメイン名を解決できません"),
    "auth_unknown_application": MessageLookupByLibrary.simpleMessage(
      "不明なアプリケーション",
    ),
    "auth_you_need_to_log_in_first_to_authorize":
        MessageLookupByLibrary.simpleMessage("認証するには最初にログインする必要があります"),
    ...
    "doctor_game_error_low_memory_info": MessageLookupByLibrary.simpleMessage(
      "仮想メモリを増やしてみてください（1080pでは、物理メモリ+仮想メモリが64GBを超える必要があります）",
    ),
    ...
    "doctor_game_error_permissions_error_info":
        MessageLookupByLibrary.simpleMessage(
          "管理者権限でランチャーを実行するか、SCToolbox（Microsoft Store版）を使用して起動してみてください。",
        ),
    ...
    "input_method_ip_address_not_found": MessageLookupByLibrary.simpleMessage(
      "サービスにアクセスするための適切なIPアドレスが見つかりませんでした。次のアドレスをお試しください（左右に切り替え）",
    ),
    ...
    "localization_info_machine_translation_warning":
        MessageLookupByLibrary.simpleMessage(
          "ゲーム内蔵テキストを使用しています。公式テキストは現在機械翻訳です（3.21.0まで）。下記のコミュニティローカリゼーションをインストールすることをお勧めします。",
        ),
    ...
    "log_analyze_log_file": MessageLookupByLibrary.simpleMessage("ログファイル:"),
    ...
    "p4k_source_error_unsupported_channel":
        MessageLookupByLibrary.simpleMessage(
          "ミラーは現在のゲームチャンネルに対応していません。公式サイトへ自動切替しません。",
        ),
    "p4k_source_keep_mirror": MessageLookupByLibrary.simpleMessage("ミラーを使い続ける"),
    ...
    "p4k_update_build_manifest_id_updated":
        MessageLookupByLibrary.simpleMessage("build_manifest.id が更新されました。"),
    "p4k_update_canceled": MessageLookupByLibrary.simpleMessage("キャンセル"),
    "p4k_update_canceling": MessageLookupByLibrary.simpleMessage("キャンセル中..."),
    "p4k_update_canceling_2": MessageLookupByLibrary.simpleMessage("キャンセル中..."),
    ...
    "p4k_update_check_disk_space_and_task_budget":
        MessageLookupByLibrary.simpleMessage("ディスク容量とタスクの予算を確認する"),
    "p4k_update_check_p4k": MessageLookupByLibrary.simpleMessage("P4K を検証"),
    ...
    "p4k_update_completed_installation_status":
        MessageLookupByLibrary.simpleMessage("インストール完了状態"),
    "p4k_update_continuing": MessageLookupByLibrary.simpleMessage("再開中..."),
    "p4k_update_create_a_p4k_rollback_record":
        MessageLookupByLibrary.simpleMessage("P4K ロールバック記録を作成"),
    "p4k_update_deep_repair": MessageLookupByLibrary.simpleMessage("詳細修復"),
    ...
    "p4k_update_deep_repair_the_current_p4k_will_be_diagnosed_first_restored_reb":
        MessageLookupByLibrary.simpleMessage(
          "詳細修復：まず現在の P4K を診断し、検証に失敗した場合のみ復元または再構築します。その後 Manifest に従って内容を検証するため、長時間かかります。通常のインストールや更新は自動では実行されません。",
        ),
    ...
    "p4k_update_download": MessageLookupByLibrary.simpleMessage("ダウンロード"),
    "p4k_update_download_basic_verification_file":
        MessageLookupByLibrary.simpleMessage("ベース検証ファイルをダウンロード"),
    ...
    "p4k_update_game_file_writing_completed":
        MessageLookupByLibrary.simpleMessage("ゲームファイルの書き込みが完了しました"),
    ...
    "p4k_update_p4k_download_update_does_not_currently_support_ptu_the_target_pa":
        MessageLookupByLibrary.simpleMessage(
          "P4K のダウンロード/アップデートは現在 PTU をサポートしていません。ターゲット パスは LIVE ディレクトリである必要があります。",
        ),
    ...
    "p4k_update_registering_eac_and_syncing_launcher_state":
        MessageLookupByLibrary.simpleMessage("EAC の登録とランチャー状態の同期"),
    ...
    "p4k_update_rsi_launcher_store_not_found_encrypted_store_sync_skipped":
        MessageLookupByLibrary.simpleMessage(
          "RSI Launcher store が見つからないため、暗号化 store の同期をスキップしました",
        ),
    ...
    "p4k_update_synchronizing_launcher_installation_status":
        MessageLookupByLibrary.simpleMessage("ランチャーのインストール状況を同期しています"),
    "p4k_update_the_manifest_url_is_missing_the_expires_keyname_signature_signat":
        MessageLookupByLibrary.simpleMessage(
          "マニフェスト URL に Expires/KeyName/Signature 署名パラメータがありません。再度ログインするか、releaseInfo 署名フィールドを確認してください。",
        ),
    "p4k_update_the_object_base_url_is_missing_the_expires_keyname_signature_sig":
        MessageLookupByLibrary.simpleMessage(
          "オブジェクトのベース URL に Expires/KeyName/Signature 署名パラメータがありません。再度ログインするか、releaseInfo 署名フィールドを確認してください。",
        ),
    ...
    "p4k_update_write": MessageLookupByLibrary.simpleMessage("書き込み"),
    ...
    "party_room_sure": MessageLookupByLibrary.simpleMessage("確認"),
    ...
    "setting_action_ignore_efficiency_cores_on_launch":
        MessageLookupByLibrary.simpleMessage(
          "ゲーム起動時に効率コアを無視（Intel第12世代以降のプロセッサに適用）",
        ),
    ...
    "setting_action_info_select_rsi_launcher_location":
        MessageLookupByLibrary.simpleMessage(
          "RSIランチャーの場所を選択してください（RSI Launcher.exe）",
        ),
    ...
    "support_dev_referral_code_message": MessageLookupByLibrary.simpleMessage(
      "まだゲームに登録していないか招待コードを入力していない場合は、私のコードを検討してください：STAR-3YXS-SWTC、ここまで読んでいただきありがとうございます",
    ),
    ...
    "tools_action_info_rsi_launcher_running_warning":
        MessageLookupByLibrary.simpleMessage(
          "RSIランチャーが実行中です！この機能を使用する前にランチャーを閉じてください！",
        ),
    ...
    "tools_unp4k_3d_browser": MessageLookupByLibrary.simpleMessage("3Dブラウザ"),
    ...
    "tools_unp4k_convertible_formats_can_be_automatically_converted_and_exported":
        MessageLookupByLibrary.simpleMessage(
          "変換可能な形式を自動的に変換してエクスポートできます (WEM->WAV、DDS->PNG、CGA/CGF->GLB)",
        ),
    "tools_unp4k_current_directory": MessageLookupByLibrary.simpleMessage(
      "現在のディレクトリ",
    ),
    "tools_unp4k_date": MessageLookupByLibrary.simpleMessage("日付"),
    "tools_unp4k_dds_to_png": MessageLookupByLibrary.simpleMessage(
      "DDSからPNGへのファイル変換",
    ),
    "tools_unp4k_decoding": MessageLookupByLibrary.simpleMessage("デコード中..."),
    ...
    "tools_unp4k_export_with_directory_structure_preserved":
        MessageLookupByLibrary.simpleMessage("ディレクトリ構造を保持したままエクスポートする"),
    ...
    "tools_unp4k_greater_than": MessageLookupByLibrary.simpleMessage("より大きい"),
    "tools_unp4k_include_original_path_when_exporting":
        MessageLookupByLibrary.simpleMessage("エクスポート時に元のパスを含めます。"),
    "tools_unp4k_jump_to_file_location": MessageLookupByLibrary.simpleMessage(
      "ファイルの場所にジャンプ",
    ),
    "tools_unp4k_less_than": MessageLookupByLibrary.simpleMessage("未満"),
    ...
    "tools_unp4k_scope": MessageLookupByLibrary.simpleMessage("範囲"),
    "tools_unp4k_search_all_files_supports_regular_expressions":
        MessageLookupByLibrary.simpleMessage("すべてのファイルを検索します (正規表現をサポート)..."),
    "tools_unp4k_search_the_current_directory_supports_regular_expressions":
        MessageLookupByLibrary.simpleMessage("現在のディレクトリを検索します (正規表現をサポート)..."),
    "tools_unp4k_select_conversion_export_location":
        MessageLookupByLibrary.simpleMessage("変換エクスポート場所の選択"),
    "tools_unp4k_select_convert_export_file":
        MessageLookupByLibrary.simpleMessage("変換してエクスポートするファイルを選択"),
    "tools_unp4k_select_export_file": MessageLookupByLibrary.simpleMessage(
      "エクスポートファイルを選択",
    ),
    "tools_unp4k_separate_with_spaces_and_do_not_include":
        MessageLookupByLibrary.simpleMessage("スペースで区切り、ピリオドは含めないでください"),
    "tools_unp4k_size": MessageLookupByLibrary.simpleMessage("サイズ"),
    "tools_unp4k_size_value": MessageLookupByLibrary.simpleMessage("サイズ値"),
    "tools_unp4k_some_day_ago": MessageLookupByLibrary.simpleMessage("指定日より前"),
    "tools_unp4k_start": MessageLookupByLibrary.simpleMessage("開始"),
    "tools_unp4k_start_export": MessageLookupByLibrary.simpleMessage(
      "エクスポートの開始",
    ),
    "tools_unp4k_suffix": MessageLookupByLibrary.simpleMessage("サフィックス"),
    ...
    "user_are_you_sure_you_want_to_log_out_of_partyroom_you_need_to_log_in":
        MessageLookupByLibrary.simpleMessage(
          "PartyRoom からログアウトしてもよろしいですか?次回ご利用時は再度ログインが必要となります。",
        ),
