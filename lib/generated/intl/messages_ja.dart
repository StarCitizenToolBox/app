...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(v0) => "入力してください ${v0}";

  static String m6(v0) => "ダウンロード中： ${v0}%    ";

  static String m7(v0) => "新しいバージョンが見つかりました -> ${v0}";

  static String m11(v0) => "ゲームが異常終了しました：${v0}";

  static String m12(v0) => "info:${v0}、右下の「グループに参加」をクリックしてフィードバックしてください。";

  static String m13(v0) => "分析完了、${v0}個の問題が見つかりました";

  static String m14(v0, v1) =>
      "フォルダの作成に失敗しました。手動で作成してみてください。\nディレクトリ：${v0} \nエラー：${v1}";

  static String m15(v0) => "修復に失敗しました、${v0}";

  static String m16(v0) => "サポートされていないオペレーティングシステム：${v0}";
  ...
  static String m20(v0) => "修正提案： ${v0}";

  static String m21(v0) =>
      "このゲームを実行するには、少なくとも16GBの物理メモリ（RAM）が必要です。（現在のサイズ：${v0}）";

  static String m22(v0) => "システムをアップグレードしてください (${v0})";

  static String m23(v0) => "ワンクリック診断 -> ${v0}";

  static String m24(v0) => "検証済み：${v0}";

  static String m25(v0) => "検証中... (${v0}%)";

  static String m26(v0, v1) => "ダウンロード： ${v0}/s    アップロード：${v1}/s";

  static String m27(v0) => "ダウンロード済み：${v0}";

  static String m28(v0) => "ダウンロード中... (${v0}%)";

  static String m29(v0) => "ステータス：${v0}";

  static String m30(v1) => "合計サイズ：${v1}";

  static String m31(v0) => "アップロード済み：${v0}";

  static String m32(v0, v1, v2, v3, v4) =>
      "ゲームが正常に終了しませんでした\nexitCode=${v0}\nstdout=${v1}\nstderr=${v2}\n\n診断情報：${v3} \n${v4}";

  static String m33(v0) => "ウェブローカリゼーションリソースの初期化に失敗しました！${v0}";

  static String m34(v0) => "スキャン完了、${v0}個の有効なインストールディレクトリが見つかりました";

  static String m35(v0) => "${v0}日  ";

  static String m36(v0) => "読み込まれたローカリゼーションバージョン：${v0}";

  static String m37(v0) => "高度なローカリゼーション -> ${v0}";

  static String m38(v0, v1) => "ローカリゼーションテキスト行数：${v0}  P4Kテキスト行数：${v1}";

  static String m39(v0) => "プレビュー：${v0}";

  static String m40(v0) => "${v0}にインストールしたローカリゼーションに新しいバージョンがあります！";

  static String m41(v1, v2) =>
      "RSIサーバーが報告するバージョン：${v1} \n\nローカルバージョン：${v2} \n\nRSI Launcherを使用してゲームを更新することをお勧めします！";

  static String m44(v0) => "コミュニティ入力メソッドサポート：${v0}";

  static String m45(v0) => "コミュニティ入力メソッドサポートが更新されました：${v0}";

  static String m46(v0, v1) =>
      "${v0}個の拡張に更新があります：${v1}。ローカライズ管理で再インストールしてください。";

  static String m47(v0, v1) => "${v0}に新バージョン${v1}があります。ローカライズ管理で再インストールしてください。";

  static String m48(v0) => "チャネル：${v0}";

  static String m49(v0) => "有効（${v0}）：";

  static String m50(v0) => "インストールエラー！\n\n ${v0}";

  static String m51(v0) => "インストール済みバージョン：${v0}";

  static String m52(v0) => "更新時間：${v0}";

  static String m53(v0) => "バージョン番号：${v0}";

  static String m54(v0, v1, v2, v3, v4) =>
      "エリア：${v0}   プレイヤー操縦：${v1}   衝突エンティティ：${v2} \n衝突ビークル：${v3}   衝突距離：${v4} ";

  static String m55(v0, v2, v3) => "被害者ID：${v0}    \n位置：${v2}  \nエリア：${v3}";

  static String m56(v0) => "詳細情報：${v0}";

  static String m57(v0, v1, v2, v3, v4) =>
      "キル数：${v0}   デス数：${v1}   自殺回数：${v2}  \n機体破壊（ソフトデス）：${v3}   機体破壊（解体）：${v4}";

  static String m58(v0, v1) => "モード：${v0}   所要時間：${v1}秒";

  static String m59(v0, v1, v2) => "${v0}時間${v1}分${v2}秒";

  static String m60(v0, v1) => "プレイヤーID：${v0}   位置：${v1}";

  static String m61(v0) => "プレイヤー ${v0} ログイン中...";

  static String m62(v0, v1, v2, v3, v4) =>
      "ビークルモデル：${v0}   \nエリア：${v1} \n損傷レベル：${v2} （${v3}）   責任者：${v4}";

  static String m63(v0) => "接続に失敗: ${v0}";

  static String m64(v0) => "${v0}日前";

  static String m65(v0) => "ルーム退出に失敗: ${v0}";

  static String m66(v0) => "認証コードの取得に失敗: ${v0}";

  static String m67(v0) => "${v0}時間前";

  static String m68(v0) => "${v0}をキックしてもよろしいですか？";

  static String m69(v0) => "メンバーのキックに失敗: ${v0}";

  static String m70(v0) => "ルームリストの読み込みに失敗: ${v0}";

  static String m71(v0, v1) => "${v0}/${v1} メンバー";

  static String m72(v0) => "${v0}分前";

  static String m73(v0) => "再接続に失敗: ${v0}";

  static String m74(v0) => "再接続に失敗、${v0}回試行済み";

  static String m75(v0) => "登録に失敗: ${v0}";

  static String m76(v0) => "${v0}にオーナー権限を移譲してもよろしいですか？";

  static String m77(v0) => "オーナー権限の移譲に失敗: ${v0}";

  static String m78(v0) => "現在の状態：${v0}";

  static String m79(v0, v1, v2) => "${v0}    最小値: ${v1} / 最大値: ${v2}";

  static String m80(v0) => "パフォーマンス最適化 -> ${v0}";
  ...
  static String m83(v0) => "⚠ AnalyticsApi.touch(\"launch\") エラー: ${v0} - 続行";

  static String m84(v0) => "✗ appModel.initApp() エラー: ${v0}";

  static String m85(v0) => "⚠ aria2cModelProvider 初期化エラー: ${v0}";

  static String m86(v0) => "⚠ URLConf.checkHost() エラー: ${v0} - 続行";

  static String m87(v0) => "⚠ appModel.checkUpdate() エラー: ${v0} - 続行";

  static String m88(v0) => "[診断] Hive boxesを閉じることに失敗: ${v0}";

  static String m89(v0) => "[診断] データベースディレクトリが存在しません: ${v0}";

  static String m90(v0) => "[診断] データベースディレクトリを削除中: ${v0}";

  static String m91(v0) => "[診断] ${v0}";

  static String m92(v0) => "診断モード - ステップ ${v0}";

  static String m93(v0) => "✗ Hive.openBox(\"app_conf\") エラー: ${v0}";

  static String m94(v0) => "[${v0}] ⚠ ログファイルが存在しません";

  static String m95(v0) => "[${v0}] --- ログ読み取り完了 (最後の1000行を表示) ---";

  static String m96(v0, v1) => "[${v0}] ✗ ログ読み取りに失敗: ${v1}";

  static String m97(v0) => "[診断] データベースリセットに失敗: ${v0}";

  static String m98(v0) => "[${v0}] 初期化を開始...";

  static String m99(v0) => "[${v0}] --- 完全なログファイルの読み取りを開始 ---";

  static String m100(v0) => "クリーンアップに失敗しました。手動で削除してください。ファイルの場所：${v0}";

  static String m101(v0) => "エラーが発生しました：${v0}";

  static String m102(v0) => "初期化に失敗しました。スクリーンショットを撮って開発者に報告してください。${v0}";
  ...
  static String m110(v0) => "処理に失敗しました！：${v0}";

  static String m111(v0) => "ランチャー情報の読み込みに失敗：${v0}";

  static String m112(v0) => "パッチ状態：${v0}";

  static String m113(v0) => "ランチャー内部バージョン情報：${v0}";

  static String m123(v0) => "ファイルを開く：${v0}";

  static String m124(v0, v1) => "読み込み完了：${v0}ファイル、所要時間：${v1} ms";

  static String m125(v0) => "ファイルを読み込み中：${v0}...";

  static String m126(v0, v1) => "ファイルを処理中(${v0}/${v1})...";

  static String m127(v0) => "不明なファイルタイプ\n${v0}";

  static String m128(v0) => "P4Kビューア -> ${v0}";

  static String m129(v0) => "${v0} 回ログイン";

  static String m130(v0) => "合計 ${v0} アカウントを検出";

  static String m131(year) =>
      "${year}年のStar Citizenプレイ統計を表示します。データはローカルログからのものです。メインのコンピュータで確認してください。";

  static String m132(year) => "${year} 年間レポート（期間限定）";

  static String m133(v0, v1, v2, v3) => "${v0}月${v1}日 - ${v2}月${v3}日";

  static String m134(v0, v1) => "${v0} 時間 ${v1} 分";

  static String m135(v0) => "${v0} 分";

  static String m136(v0, v1) => "あなたは ${v0}月${v1}日 の夜明けに宇宙の旅を始めました";

  static String m137(v0, v1) => "${v0}月${v1}日 の深夜、あなたはまだ宇宙を探索していました";

  static String m138(v0) => "${v0} 回";

  static String m139(v0) => "${v0}月";

  static String m140(v0) => "わずか ${v0} 回起動";

  static String m141(v0) => "${v0} 回起動";

  static String m142(v0) => "${v0} 時間";
  ...
  static String m145(nextYear) => "${nextYear} 年もよろしくお願いします！";

  static String m146(year) => "Star Citizen ${year} 年間レポート";

  static String m147(v0) => "${v0} 回破壊";

  static String m148(v0) => "${v0} 回操縦";

  static String m149(v0) => "全 ${v0} 車両を表示";

  static String m150(year) => "${year} 年間レポート";
