...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m128(v0, v1) => "${v0} 時間 ${v1} 分";

  static String m129(v0) => "${v0} 分";

  static String m130(v0, v1) => "あなたは ${v0}月${v1}日 の夜明けに宇宙の旅を始めました";

  static String m131(v0, v1) => "${v0}月${v1}日 の深夜、あなたはまだ宇宙を探索していました";

  static String m132(v0) => "${v0} 回";
  ...
  static String m143(v0) => "全 ${v0} 車両を表示";
