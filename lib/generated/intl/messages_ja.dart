...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m71(v0) => "ダウンロードに失敗しました。再試行しています: ${v0}";

  static String m72(v0) => "ダウンロード速度: ${v0}";

  static String m73(v0) => "ダウンロード中: ${v0}";

  static String m74(v0) => "EasyAntiCheat の登録に失敗しましたが、非致命的な警告として処理を続行します：${v0}";
  ...
  static String m77(v0) => "失敗: ${v0}";

  static String m78(v0) => "${v0}にインストール";
  ...
  static String m80(v0) => "P4K アップデーターが失敗しました: ${v0}";

  static String m81(v0) => "ゲームファイルの準備中: ${v0}";

  static String m82(v0, v1) =>
      "リリースバージョン：${v0}\n起動ファイル：${v1}\n\nreleaseInfo を読み込みました。先に「更新量を見積もる」をクリックして、Manifest が正常に解析されるか確認できます。";

  static String m83(v0, v1, v2) => "ステージ ${v0}/${v1}: ${v2}";

  static String m84(v0) =>
      "build_manifest.id の更新に失敗しました。致命的ではない警告として続行されました: ${v0}";

  static String m85(v0) => "アップデート完了: ${v0}";

  static String m86(v0) =>
      "更新された build_manifest.id: RequestedP4ChangeNum=${v0}";

  static String m87(v0) => "P4K エントリ メタデータの更新: ${v0}";

  static String m88(v0) => "検証中: ${v0}";

  static String m89(v0) => "書き込み: ${v0}";

  static String m90(v0) => "ゲームファイルの書き込み: ${v0}";

  static String m91(v0) => "接続に失敗: ${v0}";

  static String m92(v0) => "${v0}日前";

  static String m93(v0) => "ルーム退出に失敗: ${v0}";

  static String m94(v0) => "認証コードの取得に失敗: ${v0}";

  static String m95(v0) => "${v0}時間前";

  static String m96(v0) => "${v0}をキックしてもよろしいですか？";

  static String m97(v0) => "メンバーのキックに失敗: ${v0}";

  static String m98(v0) => "ルームリストの読み込みに失敗: ${v0}";

  static String m99(v0, v1) => "${v0}/${v1} メンバー";

  static String m100(v0) => "${v0}分前";

  static String m101(v0) => "再接続に失敗: ${v0}";

  static String m102(v0) => "再接続に失敗、${v0}回試行済み";

  static String m103(v0) => "登録に失敗: ${v0}";

  static String m104(v0) => "${v0}にオーナー権限を移譲してもよろしいですか？";

  static String m105(v0) => "オーナー権限の移譲に失敗: ${v0}";

  static String m106(v0) => "現在の状態：${v0}";

  static String m107(v0, v1, v2) => "${v0}    最小値: ${v1} / 最大値: ${v2}";

  static String m108(v0) => "パフォーマンス最適化 -> ${v0}";
  ...
  static String m111(v0) => "⚠ AnalyticsApi.touch(\"launch\") エラー: ${v0} - 続行";

  static String m112(v0) => "✗ appModel.initApp() エラー: ${v0}";

  static String m113(v0) => "⚠ aria2cModelProvider 初期化エラー: ${v0}";

  static String m114(v0) => "⚠ URLConf.checkHost() エラー: ${v0} - 続行";

  static String m115(v0) => "⚠ appModel.checkUpdate() エラー: ${v0} - 続行";

  static String m116(v0) => "[診断] Hive boxesを閉じることに失敗: ${v0}";

  static String m117(v0) => "[診断] データベースディレクトリが存在しません: ${v0}";

  static String m118(v0) => "[診断] データベースディレクトリを削除中: ${v0}";

  static String m119(v0) => "[診断] ${v0}";

  static String m120(v0) => "診断モード - ステップ ${v0}";

  static String m121(v0) => "✗ Hive.openBox(\"app_conf\") エラー: ${v0}";

  static String m122(v0) => "[${v0}] ⚠ ログファイルが存在しません";

  static String m123(v0) => "[${v0}] --- ログ読み取り完了 (最後の1000行を表示) ---";

  static String m124(v0, v1) => "[${v0}] ✗ ログ読み取りに失敗: ${v1}";

  static String m125(v0) => "[診断] データベースリセットに失敗: ${v0}";

  static String m126(v0) => "[${v0}] 初期化を開始...";

  static String m127(v0) => "[${v0}] --- 完全なログファイルの読み取りを開始 ---";

  static String m128(v0) => "クリーンアップに失敗しました。手動で削除してください。ファイルの場所：${v0}";

  static String m129(v0) => "エラーが発生しました：${v0}";

  static String m130(v0) => "初期化に失敗しました。スクリーンショットを撮って開発者に報告してください。${v0}";
  ...
  static String m138(v0) => "処理に失敗しました！：${v0}";

  static String m139(v0) => "ランチャー情報の読み込みに失敗：${v0}";

  static String m140(v0) => "パッチ状態：${v0}";

  static String m141(v0) => "ランチャー内部バージョン情報：${v0}";

  static String m147(v0) => "オーディオのデコードに失敗しました: ${v0}";

  static String m148(v0) => "音声プレビューに失敗しました: ${v0}";

  static String m149(v0) => "バッファ済みの範囲にのみ移動できます（現在 ${v0} 秒までバッファ済み）";

  static String m151(v0, v1) => "エクスポート完了：成功 ${v0} 件、スキップ ${v1} 件";

  static String m152(v0) => "エクスポート完了：合計 ${v0} ファイル";

  static String m156(v0) => "${v0}\n(キャッシュから)";

  static String m157(v0, v1) => "${v0}\n失敗したファイルがほかに ${v1} 件スキップされました";

  static String m158(v0) => "ファイルを開く：${v0}";

  static String m159(v0, v1) => "読み込み完了：${v0}ファイル、所要時間：${v1} ms";

  static String m160(v0) => "ファイルを読み込み中：${v0}...";

  static String m161(v0, v1) => "ファイルを処理中(${v0}/${v1})...";

  static String m162(v0) => "不明なファイルタイプ\n${v0}";

  static String m163(v0, v1) => "進行状況: ${v0}/${v1}";
  ...
  static String m165(v0) => "P4Kビューア -> ${v0}";

  static String m166(v0) => "ログアウトに失敗しました: ${v0}";

  static String m167(v0) => "更新に失敗しました: ${v0}";

  static String m168(v0) => "登録時刻: ${v0}";

  static String m169(v0) => "${v0} 回ログイン";

  static String m170(v0) => "合計 ${v0} アカウントを検出";

  static String m171(year) =>
      "${year}年のStar Citizenプレイ統計を表示します。データはローカルログからのものです。メインのコンピュータで確認してください。";

  static String m172(year) => "${year} 年間レポート（期間限定）";

  static String m173(v0, v1, v2, v3) => "${v0}月${v1}日 - ${v2}月${v3}日";

  static String m174(v0, v1) => "${v0} 時間 ${v1} 分";

  static String m175(v0) => "${v0} 分";

  static String m176(v0, v1) => "あなたは ${v0}月${v1}日 の夜明けに宇宙の旅を始めました";

  static String m177(v0, v1) => "${v0}月${v1}日 の深夜、あなたはまだ宇宙を探索していました";

  static String m178(v0) => "${v0} 回";

  static String m179(v0) => "${v0}月";

  static String m180(v0) => "わずか ${v0} 回起動";

  static String m181(v0) => "${v0} 回起動";

  static String m182(v0) => "${v0} 時間";
  ...
  static String m185(nextYear) => "${nextYear} 年もよろしくお願いします！";

  static String m186(year) => "Star Citizen ${year} 年間レポート";

  static String m187(v0) => "${v0} 回破壊";

  static String m188(v0) => "${v0} 回操縦";

  static String m189(v0) => "全 ${v0} 車両を表示";

  static String m190(year) => "${year} 年間レポート";
