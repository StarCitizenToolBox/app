...
class _CodeInputController extends ChangeNotifier with DeltaTextInputClient {
  ...
  void updateFloatingCursor(RawFloatingCursorPoint point) {
    ...
    switch (point.state) {
      ...
      case FloatingCursorDragState.Update:
        ...
        final CodeLinePosition newPosition = render.calculateTextPosition(
          adjustedClampedUpdatedOffset,
        )!;
        ...
        if (clampedUpdatedOffset.dy == topBound ||
          ...
          _floatingCursorScrollTimer ??= Timer.periodic(
            ...
            (timer) {
              ...
              final CodeLinePosition newPos = render.calculateTextPosition(
                adjustedClampedUpdatedOffset,
              )!;
              final Offset? snappedNewOffset =
...
class _TextInputConfiguration extends TextInputConfiguration {
  ...
  Map<String, dynamic> toJson() {
    return {...super.toJson(), 'viewId': flutterViewId};
  }
}
